...
<div class="form-group">
   ...
   <div class="col-sm-12">
      <input type="number" required="" class="form-control" name="mark" required="" min="0"/>
   </div>
</div>
<div class="form-group">
   ...
   <div class="col-sm-12">
      <textarea name="question_title" required="" class="form-control" id="question_title" rows="8" cols="80"></textarea>
   </div>
</div>
