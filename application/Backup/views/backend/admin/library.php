               ...
               <div class="element-wrapper">
                  <h6 class="element-header">
                     ...
                     <div style="margin-top:auto;float:right;">
                        <a href="#" data-target="#addroutine" data-toggle="modal" class="btn btn-control btn-grey-lighter btn-success">
                           ...
                           <tbody id="results">
                              ...
                              <tr>
                                 ...
                                 <td class="row-actions">
                                    ...
                                    <a onclick="delete_book('<?php echo $row['book_id'];?>')" class="danger" href="#"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                                 </td>
                              </tr>
                              <?php endforeach;?>
                           </tbody>
     ...
     function(isConfirm){
       ...
       {        
         ...
         $.ajax({
            ...
            url:"<?php echo base_url();?>admin/check_books/",
            type:'POST',
            data:{id:id},
            success:function(result)
            {
              ...
              if(result == 0){
                ...
                swal('info','Book cannot be delete','info');

              }else{
  
                 $('#results').html('<tr><td colspan="9" class="text-center"><b>deleting data...</b></td></tr>');
                 window.location.href = '<?php echo base_url();?>admin/library/delete/' + id;
