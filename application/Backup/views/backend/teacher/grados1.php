                            ...
                            <div class="tab-content">
                              ...
                              <div class="tab-pane active" id="CA">
                                <div class="row" id="results">
                                  ...
                                  <?php
                                    ...
                                    $classes = $this->db->query("SELECT t1.`class_id`, t1.`name` AS class, t3.`teacher_id`, CONCAT(t3.`first_name`,' ', t3.`last_name`) AS teacher_name, t2.`section_id` FROM class t1 LEFT JOIN section t2 ON t1.`class_id` = t2.`class_id` LEFT JOIN teacher t3 ON t2.`teacher_id` = t3.`teacher_id` WHERE t3.`teacher_id` = $tid GROUP BY class_id ORDER BY class_id ASC")->result_array();
                                        ...
                                        <div class="friend-item-content">
                                          <div class="more">
                                            ...
                                            <ul class="more-dropdown">
                                              ...
                                              ?>
                                              <hr>
                                             <li><a href="<?php echo base_url();?>teacher/students/<?php echo $cl['class_id'];?>/"><?php echo get_phrase('students');?></a></li>
                                                <!-- onclick="add_student('<?php //echo $cl['class_id'];?>')" -->
                              ...
                              <div class="tab-pane" id="ST">
                                <div class="row" id="results">
                                  <?php
                                    ...
                                    $classes = $this->db->query("SELECT t2.`class_id`, t2.`name` AS class, t3.`teacher_id`, CONCAT(t3.`first_name`,' ', t3.`last_name`) AS teacher_name FROM SUBJECT t1 LEFT JOIN class t2 ON t1.`class_id` = t2.`class_id` LEFT JOIN teacher t3 ON t1.`teacher_id` = t3.`teacher_id` WHERE t3.`teacher_id` = $tid AND section_id <> $sec_id GROUP BY class_id ORDER BY class_id ASC")->result_array();
                                        ...
                                        <div class="friend-item-content">
                                          <div class="more">
                                            ...
                                            <ul class="more-dropdown">
                                              ...
                                              ?>
                                              <hr>
                                              <li><a href="<?php echo base_url();?>teacher/students/<?php echo $cl['class_id'];?>/"><?php echo get_phrase('add_student');?></a></li><hr>
                                                <!-- onclick="add_student('<?php //echo $cl['class_id'];?>')" -->
                                              <li><a href="<?php echo base_url();?>teacher/pending/<?php echo $cl['class_id'];?>/<?php echo $cl['teacher_id'];?>"><?php echo get_phrase('accept_student');?></a></li>
                                              <?php endif;?>
                                            </ul>
                                          </div>
                              ...
                              <div class="tab-pane active" id="ST">
                                <div class="row" id="results">
                                  <?php
                                    $tid = $this->session->userdata('login_user_id'); 
                                    $classes = $this->db->query("SELECT t2.`class_id`, t2.`name` AS class, t3.`teacher_id`, CONCAT(t3.`first_name`,' ', t3.`last_name`) AS teacher_name FROM SUBJECT t1 LEFT JOIN class t2 ON t1.`class_id` = t2.`class_id` LEFT JOIN teacher t3 ON t1.`teacher_id` = t3.`teacher_id` WHERE t3.`teacher_id` = $tid GROUP BY class_id ORDER BY class_id ASC")->result_array();
