                                      ...
                                      ?>
                                        <tr>
                                           ...
                                           <td class="text-center bolder">
                                              ...
                                              <a onclick="delete_data2('<?php echo $row['live_id']?>','<?php echo $data;?>')" class="btn btn-danger btn-sm" href="#"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i> <?php echo get_phrase('delete');?></a>
     ...
     function delete_data2(id,data) {
       ...
       function(isConfirm){
         ...
         {        
           ...
           $('#results').html('<td colspan="6"> Deleting data... </td>');
           window.location.href = '<?php echo base_url();?>teacher/live_class/delete/' + id +'/'+ data;
