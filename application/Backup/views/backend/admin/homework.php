      ...
      <div class="os-tabs-w menu-shad">
         <div class="os-tabs-controls">
            <ul class="navs navs-tabs upper">
               ...
               <li class="navs-item">
                  <a class="navs-links active" href="<?php echo base_url();?>admin/homework/<?php echo $data;?>/"><i class="os-icon picons-thin-icon-thin-0004_pencil_ruler_drawing"></i><span><?php echo get_phrase('activity');?></span></a>
               </li>
               <li class="navs-item">
                        ...
                        <div class="element-box-tp">
                           <h5 class="element-header">
                              ...
                              <div style="margin-top:auto;float:right;" class="mr-5">
                                 <a href="#" data-target="#new_homework" data-toggle="modal" class="text-white btn btn-control btn-grey-lighter btn-success">
                                       ...
                                       <tbody id="results">
                                          ...
                                          <tr>
                                             ...
                                             <td class="bolder">
                                                ...
                                                <a href="<?php echo base_url();?>admin/homeworkroom/<?php echo $hm['homework_code'];?>" class="btn btn-success btn-sm"> <?php echo get_phrase('details');?></a><br>
                  ...
                  <div class="col col-lg-6 col-md-6 col-sm-6 col-6">
                     <center>
                        <div class="custom-control custom-radio" style="float: right">
                           <input  type="radio" name="type" checked="" id="1" value="1" class="custom-control-input"> <label for="1" class="custom-control-label"><?php echo get_phrase('online_text');?></label>
                        </div>
                     </center>
                  </div>
                  <div class="col col-lg-6 col-md-6 col-sm-6 col-6">
            ...
            success:function(result)
            {
              ...
              if(result == 0){
                ...
                swal('info','You cannot delete this record it has existing related information.','info');
                 ...
                 window.location.href = '<?php echo base_url(); ?>admin/homework/delete/' + id + '/' + data;
