...
<div class="modal-body">
        <div class="ui-block-title" style="background-color:#00579c">
          <h6 class="title" style="color:white"><?php echo get_phrase('update_instructional_video_link');?></h6>
        </div>
        <div class="ui-block-content">
        	<?php echo form_open(base_url() . 'admin/video_link/update/'.$link_id.'/'.$data  , array('enctype' => 'multipart/form-data'));?>
	            <div class="row">
                     ...
                     <div class="form-group label-floating is-select">
                      ...
                      <div class="select">
                        <select name="semester_id" id="semester_id">
                           ...
                           <option value="<?php echo $row['id'];?>" <?php if($query['semester_id'] == $row['exam_id']) echo 'selected';?>><?php echo $row['name'];?></option>
                           <?php endforeach;?>
