                  ...
                  <div class="ui-block responsive-flex">
                     <table class="open-topic-table" id="panel">
                        ...
                        <tbody>
                           ...
                           <?php
                              $post_id = $row['post_id'];
                              $messages = $this->db->query("SELECT * FROM forum_message where post_id = '$post_id' and is_approved = 1 order by message_id asc")->result_array();
                              
                              foreach ($messages as $row2):
                              ?>
                           <tr>
                              <td class="topic-date" colspan="2"><?php echo date('d M, Y h:i A',strtotime($row2['date_posted']))?></td>
                           </tr>
                           <tr>
                              <td class="author" width="50px" style="border-right: 1px solid #e6ecf5;">
                                 <div class="author-thumb">
                     ...
                     <div class="ui-block paddingtel">
                        ...
                        <ul class="widget w-friend-pages-added notification-list friend-requests">
                           ...
                           <li class="inline-items">
                              <div class="author-thumb">
                                 <img src="<?php echo $this->crud_model->get_image_url('student', $row['student_id']); ?>" alt="author" width="35px">
                              </div>
...
<?php endforeach;?>
<script>
   var post_message    = 'Success, please wait to approve your message.';
