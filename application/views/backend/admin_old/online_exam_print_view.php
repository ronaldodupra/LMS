               ...
               <div class="rcard-w">
                  <div class="infos">
                     <div class="info-1">
                        ...
                        <div class="company-address"><?php echo get_phrase('Online_exam_results');?></div>
                     </div>
                     <div class="info-2">
                  ...
                  <div class="rcard-heading">
                     <h5><?php echo strtoupper($online_exam_details['title']);?></h5>
                                 ...
                                 <td>
                                  <?php 
                                    if ($query->num_rows() > 0){
                                        ...
                                        $this->crud_model->get_obtained_points_exam($online_exam_id,$student_id,$query_result['obtained_mark'],$query_result['essay_mark'],$total_mark); 
