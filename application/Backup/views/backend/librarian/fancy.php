...
<header class="header" id="site-header">
    ...
    <div class="header-content-wrapper" style="float: right;">
        <div class="control-block">
            <div class="control-icon more has-items">
                ...
                <div class="more-dropdown more-with-triangle triangle-top-center">
                          ...
                          ?>
                            ...
                            <li class="message-unread">
                                ...
                                <div class="notification-event">
                                    <a href="<?php echo base_url();?>librarian/message/message_read/<?php echo $fancy_rows['message_thread_code'];?>/" class="h6 notification-friend"><?php echo $this->crud_model->get_name($fancy_user_to_show_type, $fancy_user_to_show_id);?></a>
                    ...
                    <a href="<?php echo base_url();?>librarian/message/" class="view-all bg-info"><?php echo get_phrase('view_all_messages');?></a>
                </div>
            </div>
            <div class="control-icon more has-items">
                ...
                ?>
                  <li>
                    <div class="author-thumb">
                      <?php if($fancy_notify['original_id'] > 0):?>
                        <img alt="" src="<?php echo $this->crud_model->get_image_url($fancy_notify['original_type'], $fancy_notify['original_id']);?>" width="35px">
                      <?php endif;?>
                      <?php if($fancy_notify['type'] == "event"):?>
                        <img alt="" src="<?php echo base_url();?>uploads/event.png" width="35px">
                      <?php endif;?>
                      <?php if($fancy_notify['type'] == "news"):?>
                        <img alt="" src="<?php echo base_url();?>uploads/news.png" width="35px">
                      <?php endif;?>
                    </div>
                    <div class="notification-event">
                      <div>
                  ...
                  <?php endforeach;?>
                    ...
                    <a href="<?php echo base_url();?>librarian/notifications/" class="view-all bg-info"><?php echo get_phrase('view_all_notifications');?></a>
                </div>
            </div>
            <div class="author-page author vcard inline-items more">
                <div class="author-thumb">
                    <img alt="author" src="<?php echo $this->crud_model->get_image_url('librarian', $this->session->userdata('login_user_id'));?>" class="avatar bg-white" width="32px">
                    <div class="more-dropdown more-with-triangle">
                        <div class="mCustomScrollbar" data-mcs-theme="dark">
                            <ul class="account-settings">
                                ...
                                <li>
                                    <a href="<?php echo base_url();?>login/logout/librarian">
                ...
                <a href="#" class="author-name fn">
                    <div class="author-title">
                        <?php echo $this->crud_model->get_name('librarian', $this->session->userdata('login_user_id'));?> <svg class="olymp-dropdown-arrow-icon"><use xlink:href="<?php echo base_url();?>style/olapp/svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
                    </div>
                ...
                <ul class="notification-list chat-message">
                  ...
                  ?>
                    ...
                    <li class="message-unread">
                      ...
                      <div class="notification-event">
                        <a href="<?php echo base_url();?>librarian/message/message_read/<?php echo $row1['message_thread_code'];?>/" class="h6 notification-friend"><?php echo $this->crud_model->get_name($fancy_user_to_show_type, $fancy_user_to_show_id);?></a>
                          <span class="chat-message-item" style="text-align: justify;"><?php if($rw->sender == $fancy_current_user) echo get_phrase('you').": ". substr($rw->message, 0, 90).'...'; else echo substr($rw->message, 0, 90);?>...</span>
                          <span class="notification-date"><time class="entry-date updated"><?php echo $rw->timestamp;?></time></span>
                      </div>
                    </li>
