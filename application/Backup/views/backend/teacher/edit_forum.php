  ...
  <div class="element-wrapper"> 
    <div class="element-box lined-primary shadow">
             ...
             <div class="select">
                <select name="semester_id" id="semester_id">
                   ...
                   <?php $cl = $this->db->get('exam')->result_array();
                      foreach($cl as $row):
                      ?>
                   <option value="<?php echo $row['exam_id'];?>" <?php if($row2['semester_id'] == $row['exam_id']) echo 'selected';?>><?php echo $row['name'];?></option>
                   <?php endforeach;?>
                </select>
             </div>
        </div>
        ...
        <div class="form-group">
          ...
          <textarea cols="80" id="mymce" name="description" required="" rows="2"><?php echo $row2['description'];?></textarea>
        </div>          
