...
<header class="header" id="site-header">
   <?php if($page_name == 'subject_dashboard' || $page_name == 'online_exams' || $page_name == 'online_quiz' || $page_name == 'homework' || $page_name == 'forum' || $page_name == 'study_material' || $page_name == 'live_class' || $page_name == 'video_link' || $page_name == 'subject_marks' || $page_name == 'archived_items'):?>
   <div class="page-title">
      <div class="fancy-selector-w">
         ...
         <div class="fancy-selector-options active">
            <?php 
               $fancy_subjects = $this->db->get_where('subject', array('section_id' => $fancy_section_id))->result_array();
         ...
         <div class="author-page author vcard inline-items more">
               ...
               <div class="more-dropdown more-with-triangle">
                  <div class="mCustomScrollbar" data-mcs-theme="dark">
                     <ul class="account-settings">
                        ...
                        <li>
                           <a href="<?php echo base_url();?>login/logout/student">
            ...
            <a href="#" class="author-name fn">
               <div class="author-title">
                  <?php echo $this->crud_model->get_name('student', $this->session->userdata('login_user_id'));?> 
