        ...
        <div class="row">
          <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
            <div id="newsfeed-items-grid">     
              <?php 
                $db = $this->db->query("SELECT homework_id, wall_type,publish_date FROM homework WHERE class_id = $ex[0] AND subject_id = $ex[2] AND section_id = $ex[1] UNION SELECT document_id,wall_type,publish_date FROM document WHERE class_id = $ex[0] AND subject_id = $ex[2] AND section_id = $ex[1] UNION SELECT online_exam_id,wall_type,publish_date FROM online_exam WHERE class_id = $ex[0] AND subject_id = $ex[2] AND section_id = $ex[1] UNION SELECT online_quiz_id,wall_type,publish_date FROM tbl_online_quiz WHERE class_id = $ex[0] AND subject_id = $ex[2] AND section_id = $ex[1] UNION SELECT post_id,wall_type,publish_date FROM forum WHERE class_id = $ex[0] AND subject_id = $ex[2] AND section_id = $ex[1] ORDER BY publish_date DESC LIMIT 10");
                if($db->num_rows() > 0):
              ...
              $archive_id = $this->db->query("SELECT archive_id FROM tbl_archive where person_id = '$login_id' and archive_id = '$homework_id' and archive_type='homework' and user_type='parent'")->row()->archive_id;
                ...
                <article class="hentry post thumb-full-width">                
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      ...
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>admin/insert_archive/<?php echo $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_id;?>/<?php echo $data;?>/homework/parent"><?php echo get_phrase('archive');?></a></li>
                  ...
                  <div class="edu-posts cta-with-media verde">
                    <div class="cta-content">
                      ...
                      <a href="<?php echo base_url();?>parents/homeworkroom/<?php echo $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_code;?>/<?php echo $ex[3];?>/"><button class="btn btn-rounded btn-posts"><i class="picons-thin-icon-thin-0100_to_do_list_reminder_done"></i> View <?php echo $activity_type?></button></a>
                    </div>
                  </div>
              ...
              $archive_id = $this->db->query("SELECT archive_id FROM tbl_archive where person_id = '$login_id' and archive_id = '$exam_id' and archive_type='exam' and user_type='parent'")->row()->archive_id;
                ...
                <article class="hentry post thumb-full-width">                
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      <i class="icon-options"></i>                                
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>admin/insert_archive/<?php echo $this->db->get_where('online_exam', array('online_exam_id' => $wall['homework_id']))->row()->online_exam_id;?>/<?php echo $data;?>/exam/parent"><?php echo get_phrase('archive');?></a></li>
                      </ul>
                    </div>              
                  </div>                
              ...
              $archive_id = $this->db->query("SELECT archive_id FROM tbl_archive where person_id = '$login_id' and archive_id = '$quiz_id' and archive_type='quiz' and user_type='parent'")->row()->archive_id;
                ...
                <article class="hentry post thumb-full-width">                
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      <i class="icon-options"></i>                                
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>admin/insert_archive/<?php echo $this->db->get_where('tbl_online_quiz', array('online_quiz_id' => $wall['homework_id']))->row()->online_quiz_id;?>/<?php echo $data;?>/quiz/parent"><?php echo get_phrase('archive');?></a></li>
                  ...
                  <div class="edu-posts cta-with-media blue_pallete">
                    <div class="cta-content">
                      ...
                      <a href="<?php echo base_url();?>parents/online_quiz/<?php echo $data;?>/"><button class="btn btn-rounded btn-success"><i class="picons-thin-icon-thin-0014_notebook_paper_todo"></i> <?php echo get_phrase('go_to_quiz');?></button></a><br>
              ...
              <!-- Exit Quiz Dashboard -->
               ...
               <?php 
                ...
                $archive_id = $this->db->query("SELECT archive_id FROM tbl_archive where person_id = '$login_id' and archive_id = '$document_id' and archive_type='material' and user_type='parent'")->row()->archive_id;
                ...
                <article class="hentry post thumb-full-width">
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      <i class="icon-options"></i>                                
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>admin/insert_archive/<?php echo $this->db->get_where('document', array('document_id' => $wall['homework_id']))->row()->document_id;?>/<?php echo $data;?>/material/parent"><?php echo get_phrase('archive');?></a></li>
                      </ul>
                    </div>                
                  </div>                
                  ...
                  $archive_id = $this->db->query("SELECT archive_id FROM tbl_archive where person_id = '$login_id' and archive_id = '$forum_id' and archive_type='forum' and user_type='parent'")->row()->archive_id;
                ...
                <article class="hentry post thumb-full-width">                
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      <i class="icon-options"></i>                                
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>admin/insert_archive/<?php echo $this->db->get_where('forum', array('post_id' => $wall['homework_id']))->row()->post_id;?>/<?php echo $data;?>/forum/parent"><?php echo get_phrase('archive');?></a></li>
                      </ul>
                    </div>                 
                  </div>                
                      ...
                      <ul class="widget w-activity-feed notification-list">
                        ...
                        <li>
                          ...
                          <div class="notification-event">
                            <a href="javascript:void(0);" class="notification-friend"><?php echo get_phrase($notify['notify']);?>.</a>
              ...
              <div class="col col-xl-3 order-xl-3 col-lg-6 order-lg-3 col-md-6 col-sm-12 col-12">
                <div class="crumina-sticky-sidebar">
                  <div class="sidebar__inner">
                    ...
                    <a class="btn btn-block btn-info mb-3" href="<?php echo base_url();?>parents/archived_items/<?php echo $data;?>/">Archived items</a>
