...
<div class="modal-body">
        <div class="modal-header" style="background-color:#00579c">
            <h6 class="title" style="color:white"><?php echo get_phrase('update_grade_level');?></h6>
        </div>
        ...
        <?php echo form_open(base_url() . 'admin/grade/update/'.$row['grade_id'] , array('enctype' => 'multipart/form-data'));?>
         ...
         <div class="form-group row">
          ...
          <div class="form-buttons-w">
            <button class="btn btn-rounded btn-success" style="float: right;" type="submit"> <?php echo get_phrase('update');?></button><br>
          </div>
          </div>
          </div>
        <?php echo form_close();?>
