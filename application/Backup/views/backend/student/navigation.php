  ...
  <div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      <ul class="left-menu">
        ...
        <li>
          <a href="<?php echo base_url();?>student/live_conference/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('live_conference');?>">
            <div class="left-menu-icon">
  ...
  <div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1">
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      <ul class="left-menu">
        ...
        <li>
          <a href="<?php echo base_url();?>student/live_conference/">
            <div class="left-menu-icon">
              <i class="os-icon picons-thin-icon-thin-0273_video_multimedia_movie"></i>
            </div>
