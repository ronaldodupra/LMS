  ...
  <div class="header-spacer"></div>
    ...
    <div class="content-i">
      <div class="content-box">
        <div class="back">
          <a href="<?php echo base_url();?>parents/subject_dashboard/<?php echo $data;?>"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>
        </div>
        <div class="row">
                  ...
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      ...
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>admin/unarchive/<?php echo $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_id;?>/<?php echo $data;?>/homework/parent"><?php echo get_phrase('Unarchive');?></a></li>
                ...
                <article class="hentry post thumb-full-width">                
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      <i class="icon-options"></i>                                
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>admin/unarchive/<?php echo $this->db->get_where('online_exam', array('online_exam_id' => $wall['homework_id']))->row()->online_exam_id;?>/<?php echo $data;?>/exam/parent"><?php echo get_phrase('unarchive');?></a></li>
                      </ul>
                    </div>              
                  </div>                
                ...
                <article class="hentry post thumb-full-width">                
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      <i class="icon-options"></i>                                
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>admin/unarchive/<?php echo $this->db->get_where('tbl_online_quiz', array('online_quiz_id' => $wall['homework_id']))->row()->online_quiz_id;?>/<?php echo $data;?>/quiz/parent"><?php echo get_phrase('archive');?></a></li>
                  ...
                  <div class="edu-posts cta-with-media blue_pallete">
                    <div class="cta-content">
                      ...
                      <a href="<?php echo base_url();?>parent/online_quiz/<?php echo $data;?>/"><button class="btn btn-rounded btn-success"><i class="picons-thin-icon-thin-0014_notebook_paper_todo"></i> <?php echo get_phrase('go_to_quiz');?></button></a><br>
                ...
                <article class="hentry post thumb-full-width">
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      <i class="icon-options"></i>                                
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>admin/unarchive/<?php echo $this->db->get_where('document', array('document_id' => $wall['homework_id']))->row()->document_id;?>/<?php echo $data;?>/material/parent"><?php echo get_phrase('unarchive');?></a></li>
                      </ul>
                    </div>                
                  </div>                
                ...
                <article class="hentry post thumb-full-width">                
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      <i class="icon-options"></i>                                
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>admin/unarchive/<?php echo $this->db->get_where('forum', array('post_id' => $wall['homework_id']))->row()->post_id;?>/<?php echo $data;?>/forum/parent"><?php echo get_phrase('unarchive');?></a></li>
                      </ul>
                    </div>                 
                  </div>                
