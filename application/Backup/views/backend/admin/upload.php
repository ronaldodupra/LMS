  									...
  									<div class="app-email-i">
    									<div class="ae-side-menu">
      										...
      										<ul class="ae-main-menu">
        										...
        										<li><a href="<?php echo base_url();?>admin/folders/"><i style="font-size:15px;" class="picons-thin-icon-thin-0111_folder_files_documents"></i><span><?php echo get_phrase('folder');?></span></a></li>
      										</ul>
    									</div>
          											...
          											<div class="aec-full-message">
          											    <div class="message-head">
              												<div class="user-w with-status status-green">
                												<div class="user-name">
                  													<h3 class="user-title"><?php echo get_phrase('upload_new_file');?></h3>
                												</div>
              												</div>
            											</div>
            											    <div class="message-content" style="text-align: center;">
              												    <div id="dropzone" style="border: 3px dotted #0061da;">
                  												    <form action="/upload" class="dropzone needsclick dz-clickable" id="demo-upload" style="border:0px;">
