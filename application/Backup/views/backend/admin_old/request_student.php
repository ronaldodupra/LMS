         ...
         <div class="tab-content ">
               ...
               <div class="element-wrapper">
                  <h6 class="element-header">
                     ...
                     <div style="margin-top:auto;text-align:right;">
                        <a href="#" data-target="#addroutine" data-toggle="modal" class="btn btn-control btn-grey-lighter btn-purple">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="bolder">
                                    ...
                                    <a onclick="delete_request_student('<?php echo $row['code'];?>')" href="#" style="color:grey;"><i style="font-size:20px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete');?>"></i></a>
                                 </td>
                              </tr>
                              <?php endforeach;?>
                           </tbody>
            ...
            <div class="tab-pane" id="teachers">
               <div class="element-wrapper">
                  ...
                  <div class="element-box-tp">
                     <div class="table-responsive">
                        <table class="table table-padded" id="teachers_report">
                           <thead>
                              <tr>
                                 <th><?php echo get_phrase('priority');?></th>
                                 <th><?php echo get_phrase('date');?></th>
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="bolder">
                                    ...
                                    <a onclick="delete_request_teacher('<?php echo $row['report_code'];?>')" href="#" style="color:grey;"><i style="font-size:20px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete');?>"></i></a>
                                 </td>
                              </tr>
                              <?php endforeach;?>
                           </tbody>
...
<script type="text/javascript">
   ...
   function delete_request_student(id) {
     ...
     function(isConfirm){
       ...
       {        
         ...
         $.ajax({
            ...
            url:"<?php echo base_url();?>admin/check_request_student/",
            type:'POST',
            data:{id:id},
            success:function(result)
            {
              ...
              if(result == 0){
                ...
                swal('info','Student request cannot be delete','info');

              }else{
  
                 $('#student_report').html('<tr><td colspan="8" class="text-center"><b>deleting data...</b></td></tr>');
                 window.location.href = '<?php echo base_url();?>admin/request_student/delete/' + id;
    ...
    function delete_request_teacher(id) {
     ...
     function(isConfirm){
       ...
       {          
         ...
         $.ajax({
            ...
            url:"<?php echo base_url();?>admin/check_request_teacher/",
            type:'POST',
            data:{id:id},
            success:function(result)
            {
              ...
              if(result == 0){
                //alert('cannot be delete');
                swal('info','Teacher request cannot be delete','info');

              }else{
  
                 $('#teachers_report').html('<tr><td colspan="6" class="text-center"><b>deleting data...</b></td></tr>');
                 window.location.href = '<?php echo base_url();?>admin/request_student/delete_teacher/' + id;
