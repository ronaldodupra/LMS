         ...
         <div class="row">
            <div class="col  col-sm-12 col-12">
               <div class="ui-block">
                  ...
                  <ul class="notification-list" id="results">
                     ...
                     <li>
                        ...
                        <div class="notification-event">
                           ...
                           <a onclick="delete_notif('<?php echo $notify['id'];?>')" href="#"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full"></i></a>
                        </div>
                     </li>
                     <?php endforeach;?>
                  </ul>
   ...
   function delete_notif(id) {
     ...
     function(isConfirm){
       ...
       {        
         ...
         $('#results').html('<li class="text-center"> Deleting data... </li>');
         window.location.href = '<?php echo base_url();?>admin/notifications/delete/' + id;
