               ...
               <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
                  <div id="newsfeed-items-grid">
                           ...
                           <div class="post__author author vcard inline-items">
                              ...
                              <div class="more">
                                 ...
                                 <ul class="more-dropdown">
                                    <li><a href="<?php echo base_url();?>admin/insert_archive/<?php echo $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_id;?>/<?php echo $data;?>/homework/admin"><?php echo get_phrase('archive');?></a></li>
                        ...
                        <article class="hentry post thumb-full-width">
                           <div class="post__author author vcard inline-items">
                              ...
                              <div class="more">
                                 <i class="icon-options"></i>                                
                                 <ul class="more-dropdown">
                                    <li><a href="<?php echo base_url();?>admin/insert_archive/<?php echo $this->db->get_where('online_exam', array('online_exam_id' => $wall['homework_id']))->row()->online_exam_id;?>/<?php echo $data;?>/exam/admin"><?php echo get_phrase('archive');?></a></li>
                        ...
                        <article class="hentry post thumb-full-width">
                           <div class="post__author author vcard inline-items">
                              ...
                              <div class="more">
                                 <i class="icon-options"></i>                                
                                 <ul class="more-dropdown">
                                    <li><a href="<?php echo base_url();?>admin/insert_archive/<?php echo $this->db->get_where('document', array('document_id' => $wall['homework_id']))->row()->document_id;?>/<?php echo $data;?>/material/admin"><?php echo get_phrase('archive');?></a></li>
                        ...
                        <article class="hentry post thumb-full-width">
                           <div class="post__author author vcard inline-items">
                              ...
                              <div class="more">
                                 <i class="icon-options"></i>                                
                                 <ul class="more-dropdown">
                                    <li><a href="<?php echo base_url();?>admin/insert_archive/<?php echo $this->db->get_where('forum', array('post_id' => $wall['homework_id']))->row()->post_id;?>/<?php echo $data;?>/forum/admin"><?php echo get_phrase('archive');?></a></li>
                     ...
                     <?php 
                      ...
                      $archive_id = $this->db->query("SELECT archive_id FROM tbl_archive where person_id = '$login_id' and archive_id = '$link_id' and archive_type='video%20link' and user_type='admin'")->row()->archive_id;
                        ...
                        <article class="hentry post thumb-full-width">
                           <div class="post__author author vcard inline-items">
                              ...
                              <div class="more">
                                 <i class="icon-options"></i>                                
                                 <ul class="more-dropdown">
                                    <li><a href="<?php echo base_url();?>admin/insert_archive/<?php echo $this->db->get_where('tbl_video_link', array('link_id' => $wall['homework_id']))->row()->link_id;?>/<?php echo $data;?>/video link/admin"><?php echo get_phrase('archive');?></a></li>
                                    <li>
                     ...
                     <?php 
                      ...
                      $archive_id = $this->db->query("SELECT archive_id FROM tbl_archive where person_id = '$login_id' and archive_id = '$live_id' and archive_type='live%20class' and user_type='admin'")->row()->archive_id;
                        ...
                        <article class="hentry post thumb-full-width">
                           <div class="post__author author vcard inline-items">
                              ...
                              <div class="more">
                                 <i class="icon-options"></i>                                
                                 <ul class="more-dropdown">
                                    <li><a href="<?php echo base_url();?>admin/insert_archive/<?php echo $this->db->get_where('tbl_live_class', array('live_id' => $wall['homework_id']))->row()->live_id;?>/<?php echo $data;?>/live class/admin"><?php echo get_phrase('archive');?></a></li>
                                    <li>
                           ...
                           <div class="edu-posts cta-with-media naranja">
                              <div class="cta-content">
                                 ...
                                 $room_name = sha1($title.'-'.$timestamp);
                               ...
                               <a title="Join Live Classroom" href="<?php echo base_url();?>jitsi_meet/host.php?data=<?php echo $room_name.'-'.$sname;?>" target="_blank" class="btn btn-info laptop_desktop btn-rounded"> <i class="picons-thin-icon-thin-0324_computer_screen"></i> <?php echo get_phrase('Join Live Classroom');?></a>
  ...
  function delete_videlink(id,data) {
     ...
     function(isConfirm){
       ...
       {        
         ...
         window.location.href = '<?php echo base_url();?>admin/video_link/delete/' + id + '/' + data + '/load_dashboard';
   ...
   function delete_liveclass(id,data) {
       ...
       function(isConfirm){
         ...
         {        
           ...
           window.location.href = '<?php echo base_url();?>admin/live_class/delete/' + id +'/'+ data + '/load_dashboard';
