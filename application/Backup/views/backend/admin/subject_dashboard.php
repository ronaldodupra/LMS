                           ...
                           <div class="edu-posts cta-with-media naranja">
                              <div class="cta-content">
                                ...
                                if($host_id == 1){ ?>
                                  ...
                                  <a title="Join Live Classroom" href="<?php echo $zoom_link ?>" target="_blank" class="btn btn-info btn-rounded"> <i class="picons-thin-icon-thin-0191_window_application_cursor"></i> <?php echo get_phrase('Join Live Classroom');?></a>

                                <?php }else if($host_id == 2){ ?>

                                  <!-- Zitsi Meet -->

                                  <a title="Join Live Classroom" href="<?php echo base_url();?>jitsi_meet/client.php?data=<?php echo base64_encode($room_name.'-'.$sname);?>" target="_blank" class="btn btn-info laptop_desktop btn-rounded"> <i class="picons-thin-icon-thin-0324_computer_screen"></i> <?php echo get_phrase('Join Live Classroom');?></a>
