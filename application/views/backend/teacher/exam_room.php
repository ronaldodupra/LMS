                        ...
                        <div style="overflow-x:auto;">
                           <table  class="table table-bordered">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td colspan="5" class="text-center"><?php echo get_phrase('no_questions');?></td>
                                 </tr>
                                 <?php
                                 ...
                                 <tr>
                                    ...
                                    <?php if ($added_question['type'] == 'fill_in_the_blanks'): ?>
                                      ...
                                      <td>
                                        ...
                                        if($img <> ''){ ?>
                                         ...
                                         <img src="<?php echo base_url('uploads/online_exam/'.$added_question['image']);?>" class="img-fluid" width="150px;">
                                    ...
                                    <td style="text-align: center;">
                                       <a href="javascript:void(0)" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/update_online_exam_question/<?php echo $added_question['question_bank_id'];?>')" class="btn btn-success btn-sm"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new" aria-hidden="true"></i></a>
                                       <a onclick="delete_q('<?php echo $added_question['question_bank_id'];?>')" href="javascript:void(0)" class="btn btn-danger btn-sm"  data-toggle="tooltip" title="<?php echo get_phrase('delete'); ?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" aria-hidden="true"></i></a>
                                    </td>
                                 </tr>
                                 <?php endforeach; ?>
                                 <?php endif; ?>
