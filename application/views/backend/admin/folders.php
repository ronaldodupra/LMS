                                          ...
                                          <ul class="widget w-friend-pages-added notification-list friend-requests">
                                             ...
                                             <li class="inline-items">
                                                ...
                                                <div class="notification-event">
                                                   ...
                                                   <a onclick="delete_folder('<?php echo $row['folder_id'];?>')" href="#">
                                                    <i style="font-size:15px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full"></i>
                                                   </a>
                                                </div>
   ...
   function delete_folder(id) {
     ...
     function(isConfirm){
       ...
       {        
         ...
         window.location.href = '<?php echo base_url();?>admin/folders/delete/' + id;
   ...
   function delete_file(id) {
     ...
     function(isConfirm){
       ...
       {        
         ...
         $('#results').html('<div class="col-md-12 text-center"><img src="<?php echo base_url();?>assets/images/preloader.gif" /><br><b>deleting data..</b></div>');
         window.location.href = '<?php echo base_url();?>admin/files/delete/' + id;
