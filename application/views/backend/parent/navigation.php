  ...
  <div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      <ul class="left-menu">
        ...
        <li>
          <a href="<?php echo base_url();?>parents/live_conference/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('live_conference');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>parents/class_routine/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('class_schedule');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>parents/attendance_report/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('attendance');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>parents/library/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('library');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>parents/marks/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('grade');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>parents/subjects/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('class');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>parents/student_report/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('behavior');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>parents/calendar/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('calendar');?>">
            <div class="left-menu-icon">
        ...
        <li>
          <a href="<?php echo base_url();?>parents/invoice/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo get_phrase('payments');?>">
            <div class="left-menu-icon">
  ...
  <div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1">
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      <ul class="left-menu">
        ...
        <li>
          <a href="<?php echo base_url();?>parents/live_conference/">
            <div class="left-menu-icon">
              <i class="os-icon picons-thin-icon-thin-0273_video_multimedia_movie"></i>
            </div>
