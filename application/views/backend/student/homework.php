   ...
   <div class="conty">
      ...
      <div class="cursos cta-with-media" style="background: #<?php echo $row['color'];?>;">
         <div class="cta-content">
            ...
            <h3 class="cta-header"><?php echo $row['name'];?> - <small><?php echo get_phrase('activity');?></small></h3>
      ...
      <div class="os-tabs-w menu-shad">
         <div class="os-tabs-controls">
            <ul class="navs navs-tabs upper">
               ...
               <li class="navs-item">
                  <a class="navs-links active" href="<?php echo base_url();?>student/homework/<?php echo $data;?>/"><i class="os-icon picons-thin-icon-thin-0004_pencil_ruler_drawing"></i><span><?php echo get_phrase('activity');?></span></a>
               </li>
               <li class="navs-item">
                  ...
                  <div id="newsfeed-items-grid">
                     <div class="element-wrapper">
                        <div class="element-box-tp">
                           <h5 class="element-header"><?php echo get_phrase('homework');?></h5>
                           <div class="os-tabs-w">
                              <div class="os-tabs-controls">
                                 <ul class="navs navs-tabs upper">
                                    <?php 
                                    ...
                                    <table class="table table-padded">
                                       ...
                                       <tbody>
                                          <?php
                                             ...
                                             $homeworks = $this->db->query("SELECT * from homework where class_id = '$ex[0]' and section_id = '$ex[1]' and subject_id = '$ex[2]' and status = 1 and semester_id = '$semester_id' order by homework_id desc");
                                          ...
                                          <tr>
                                             ...
                                             <td class="bolder">
                                                ...
                                                <a href="<?php echo base_url();?>student/homeworkroom/<?php echo $row['homework_code']; ?>" class="btn btn-success"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i> <?php echo get_phrase('details');?></a>
