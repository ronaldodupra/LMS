           ...
           <div class="ui-blo ck">
				<div class="top-header top-header-favorit">
					<div class="top-header-thumb">
						<img src="https://wsg.com.gt/edu/uploads/bglogin.jpg" alt="nature" style="height:180px; object-fit:cover;">
						<div class="top-header-author">
							<div class="author-thumb">
								<img src="https://wsg.com.gt/edu/uploads/logo.png" alt="author" style="background-color: #fff;">
							</div>
				...
				<div class="ui-block-title">
					<h6 class="title"><?php echo get_phrase('your_notifications');?></h6>
				        ...
				        <ul class="notification-list">
					        ...
					        <li>
						        <div class="author-thumb">
							        <img src="https://image.flaticon.com/icons/svg/928/928904.svg">
						        </div>
						        <div class="notification-event">
							        ...
							        <a onClick="return confirm('<?php echo get_phrase('confirm_delete');?>')" href="<?php echo base_url();?>librarian/notification/delete/<?php echo $notify['id'];?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full"></i></a>
						        </div>
					        </li>
					        <?php endforeach;?>
				        </ul>
