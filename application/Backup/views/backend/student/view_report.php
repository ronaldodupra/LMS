          ...
          <h6 class="title"><?php echo get_phrase('teacher');?></h6>
                            ...
                            <div class="ui-block-content">
                                <div class="widget w-about" style="text-align:center">
                                    ...
                                    <h4><?php echo $this->crud_model->get_name('teacher', $row['teacher_id']);?><br> <small>Telephone:  <?php echo $this->db->get_where('teacher', array('teacher_id' => $row['teacher_id']))->row()->phone;?>.</small></h4>
