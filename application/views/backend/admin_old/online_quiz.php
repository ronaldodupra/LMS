   ...
   <div class="conty">
      ...
      <div class="cursos cta-with-media" style="background: #<?php echo $row['color'];?>;">
         <div class="cta-content">
            ...
            <h3 class="cta-header"><?php echo $row['name'];?> - <small><?php echo get_phrase('online_quiz');?></small></h3>
      ...
      <div class="os-tabs-w menu-shad">
         <div class="os-tabs-controls">
            <ul class="navs navs-tabs upper">
               ...
               <li class="navs-item">
                  <a class="navs-links active" href="<?php echo base_url();?>admin/online_quiz/<?php echo $data;?>/"><i class="os-icon picons-thin-icon-thin-0678_pen_writting_fontain"></i><span><?php echo get_phrase('online_quiz');?></span></a>
               </li>
               <li class="navs-item">
                        ...
                        <div class="element-box-tp">
                           <h5 class="element-header">
                              ...
                              <div style="margin-top:auto;float:right;" class="mr-5">
                                 <a href="#new_quiz_modal" data-toggle="modal" class="text-white btn btn-control btn-grey-lighter btn-success">
                                   ...
                                   <tbody id="results">
                                      ...
                                      <tr>
                                         ...
                                         <td class="bolder">
                                            ...
                                            <a href="<?php echo base_url();?>admin/quizroom/<?php echo $row['online_quiz_id'];?>" class="btn btn-success btn-sm"> <?php echo get_phrase('details');?></a>
      ...
      <div class="modal-content" style="margin-top:0px;">
         ...
         <div class="modal-body">
            ...
            <div class="ui-block-content">
               <div class="row">
                  <div class="col-md-12">
                      <?php echo form_open(base_url() . 'admin/create_online_quiz/'.$data, array('enctype' => 'multipart/form-data')); ?>
                     <div class="row">
                        <div class="col-md-9">
                        ...
                        <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <div class="input-group">
                                 <input type='text' class="datepicker-here" data-position="top left" data-language='en' name="quiz_date" data-multiple-dates-separator="/" required="" />
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        ...
                        <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <div class="input-group">
                                 <input type="number" min="0" max="100" required="" class="form-control" placeholder="0 to 100" name="minimum_percentage" >
                              </div>
                           </div>
                        </div>
                        <div class="col-md-3">
   ...
   function publish_data(id,data) {
     ...
     function(isConfirm){
       ...
       {        
         ...
         window.location.href = '<?php echo base_url();?>admin/manage_online_quiz_status/' + id + '/published/' + data +'/';
   ...
   function mark_expired_data(id,data) {
     ...
     function(isConfirm){
       ...
       {        
         ...
         window.location.href = '<?php echo base_url();?>admin/manage_online_quiz_status/' + id + '/expired/' + data +'/';
     ...
     function(isConfirm){
       ...
       {        
         ...
         $.ajax({
            ...
            url:"<?php echo base_url();?>admin/check_quiz/",
            type:'POST',
            data:{id:id},
            success:function(result)
            {
              ...
              if(result == 0){
                ...
                swal('info','You cannot delete this record it has existing related information.','info');
                 ...
                 window.location.href = '<?php echo base_url();?>admin/manage_quiz/delete/' + id +'/'+ data;
