      ...
      <div class="os-tabs-w menu-shad">
         <div class="os-tabs-controls">
            <ul class="navs navs-tabs upper">
               <li class="navs-item">
                    <a class="navs-links active" href="<?php echo base_url();?>admin/manage_examiner_adviser/"><i class="fa fa-users fa-2x"></i><span> Manage Allow Examiners</span></a> 
            ...
            <div class="col-sm-12">
               <div class="row">
                  <div class="col-sm-12">
                    ...
                    <?php echo form_open(base_url() . 'admin/manage_examiner_adviser/', array('class' => 'form m-b'));?>
...
<script type="text/javascript">
  ...
  function load_selected_section(){
    ...
    $.ajax({
      ...
      url: '<?php echo base_url();?>admin/selected_section_examiner',
      data:mydata,
      method:"POST",
      cache:false,
    ...
    $('#btn_update').click(function(){
      ...
      function(isConfirm){
        ...
        {  
          ...
          $.ajax({
            url:'<?php echo base_url();?>admin/save_update_examiner_adviser',
            method:'POST',
