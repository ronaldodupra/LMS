      ...
      <div class="os-tabs-w menu-shad">
         <div class="os-tabs-controls">
            <ul class="navs navs-tabs upper">
               ...
               <li class="navs-item">
                  <a class="navs-links active" href="<?php echo base_url();?>teacher/video_link/<?php echo $data;?>/"><i class="os-icon picons-thin-icon-thin-0273_video_multimedia_movie"></i><span><?php echo get_phrase('video_links');?></span></a>
               </li>
               <li class="navs-item">
                                    ...
                                    <table class="table table-padded">
                                       <thead>
                                          <tr>
                                             ...
                                             <th style="width: 20%"><?php echo get_phrase('link_name');?></th>
                                       ...
                                       <tbody id="results">
                                          <?php
                                             ...
                                             $study_material_info = $this->db->query("SELECT t2.`name` AS semester_name, t1.* FROM tbl_video_link t1 LEFT JOIN exam t2 ON t1.`semester_id` = t2.`exam_id`
                                              where subject_id = $ex[2] and class_id = $ex[0] and section_id = $ex[1] and semester_id = '$semester_id' order by link_id desc ");
                                             ...
                                             <tr>
                                                <td><?php echo $row['description']?></td>
                                                 ...
                                                 <td class="text-center bolder"> 
                                                    ...
                                                    <a style="color:grey;" onclick="delete_videlink('<?php echo $row['link_id']?>','<?php echo $data;?>')"  href="#"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                                                 </td>
                                             </tr>
                                          <?php endforeach;
                                             else:?>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <div class="ui-block-content">
               <?php echo form_open(base_url() . 'teacher/video_link/create/'.$data, array('enctype' => 'multipart/form-data')); ?>
               <div class="row">
   ...
   function delete_videlink(id,data) {
     ...
     function(isConfirm){
       ...
       {        
         ...
         window.location.href = '<?php echo base_url();?>teacher/video_link/delete/' + id + '/' + data;
