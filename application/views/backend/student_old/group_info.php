<?php
 ...
 <div class="modal-body" style="margin-top:0px;">
        <div class="modal-header" style="background-color:#00579c">
            <h6 class="title" style="color:white"><?php echo get_phrase('group_information');?></h6>
        </div>
    ...
    <table  class="table table-bordered">
      ...
      <thead>
        <tr class="bg-primary">
          <th class="text-white text-center"><?php echo get_phrase('photo'); ?></th>
          <th class="text-white text-center"><?php echo get_phrase('name'); ?></th>
          <th class="text-white text-center"><?php echo get_phrase('email'); ?></th>
        </tr>
      </thead>
      ...
      ?>
        <tr>
          <td> <img src="<?php echo $this->crud_model->get_image_url($user_type, $user_id); ?>" class="img-circle" width="35"></td>
