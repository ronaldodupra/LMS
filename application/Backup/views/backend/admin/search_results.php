		...
		<div class="col  col-sm-12 col-12">
			<div class="ui-block">
				<div class="ui-block-title">
					<h6 class="title"><?php echo get_phrase('search_results');?></h6>
				</div>
				 <?php 
				   ...
				   <?php  foreach($students as $row):?>
					<li>
						<div class="author-thumb">
							<img src="<?php echo $this->crud_model->get_image_url('student', $row['student_id']);?>" width="35px">
						</div>
						<div class="notification-event">
							<a href="<?php echo base_url();?>admin/student_portal/<?php echo $row['student_id'];?>/" class="h6 notification-friend"><?php echo $this->crud_model->get_name('student', $row['student_id']) ;?></a>.
				...
				<div class="bg-danger">
				   ...
				   <h3 class="text-white"> <?php echo get_phrase('no_results_found');?></h3><br><br>
				   </div>
				   </div>
				</div>
                <?php endif;?>
