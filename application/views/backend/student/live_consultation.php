    ...
    <div class="os-tabs-w menu-shad">
      <div class="os-tabs-controls">
        <ul class="navs navs-tabs upper">
          <li class="navs-item">
            <a class="navs-links" href="<?php echo base_url();?>student/send_report/"><i class="os-icon picons-thin-icon-thin-0389_gavel_hammer_law_judge_court"></i><span><?php echo get_phrase('reports');?></span></a>
          </li>
          <li class="navs-item">
            <a class="navs-links active" href="<?php echo base_url();?>student/live_consultation/"><i class="os-icon picons-thin-icon-thin-0273_video_multimedia_movie"></i><span><?php echo get_phrase('Live Meeting');?></span></a>
          </li>
        </ul>
      </div>
    </div>
            ...
            <table class="table table-padded" id="student_report">
              ...
              <tbody>
                ...
                <?php
                  ...
                  $con_live_info = $this->db->query("SELECT * FROM tbl_live_consultation WHERE member_type = '1' ORDER BY consultation_id DESC");
                ...
                <tr>
                  ...
                  <td class="text-center bolder">
                    ...
                    <?php else:
                      $zoom_link=$this->db->get_where('student', array('student_id' => $student_id))->row()->zoom_link; 
                    ?>
