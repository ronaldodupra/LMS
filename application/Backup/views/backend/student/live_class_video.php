...
$fname = $this->db->query("SELECT first_name FROM student where student_id = '$student_id'")->row()->first_name; 
$lname = $this->db->query("SELECT last_name FROM student where student_id = '$student_id'")->row()->last_name; 

$sname = $fname . ' ' . $lname;

$meeting_id = $this->db->query("SELECT * FROM teacher where teacher_id = '$teacher_id'")->row()->zoom_id; 
$zoom_pass = $this->db->query("SELECT * FROM teacher where teacher_id = '$teacher_id'")->row()->zoom_password;
                     ...
                     <div class="element-wrapper">
                        ...
                        <div class="row">
                          <?php if ($row['host_id'] == 1): ?>
                            <div class="col-md-12">
                              <div class="embed-responsive embed-responsive-16by9" id="video_div">
                                <iframe class="embed-responsive-item" id="" src="<?php echo base_url();?>CDN/index.php?mid=<?php echo $meeting_id; ?>&pwd=<?php echo $zoom_password; ?>&sname=<?php echo $sname; ?>" allowfullscreen>
                                </iframe>
                              </div>
                            </div>
                            ...
                            <div class="col-md-12 mt-4">
                              <center>
                                <span class="badge badge-success">CLICK HERE TO REDIRECT ON YOUR ZOOM APPLICATION.</span><br><br>
                                <a type="button" class="btn btn-primary btn-lg" href="https://us04web.zoom.us/j/<?php echo $meeting_id;?>?pwd=<?php echo $zoom_password?>" target="_blank"><i class="picons-thin-icon-thin-0191_window_application_cursor"></i> Click Here</a>
                              </center>
                            </div>
                          ...
                          <?php else:?>
                            ...
                            <div class="col-md-12">
                              <div class="embed-responsive embed-responsive-16by9" id="video_div">
                                <iframe class="embed-responsive-item" id="" src="https://meet.jit.si/<?php echo $room_name?>" allowfullscreen></iframe>
                              </div>
                            </div>
