                        ...
                        <table class="table table-lightborder table-striped table-hover">
                           ...
                           <tbody id="results">
                              ...
                              <tr>
                                ...
                                <td class="text-center">
                                  <span class="badge badge-primary" title="Exam Attendees"> <span class="fa fa-pencil-alt"></span> <?php echo $attended;?></span>
                                </td>
                                <td><a class="btn btn-primary btn-sm" href="<?php echo base_url().'admin/exam_results/'.$row['online_exam_id']; ?>" target="_blank"> <span class="fa fa-eye"></span> View Results </a></td>
                              </tr>
                              <?php endforeach; ?>
                           </tbody>
                        </table>
