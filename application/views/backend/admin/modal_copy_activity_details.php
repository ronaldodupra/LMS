                ...
                <div class="form-group">
                     ...
                     <div class="select">
                        ...
                        <select id="sec_id" required="" name="sec_id" onchange="subject_holder(this.value);">
                           ...
                           $class = $this->db->query("SELECT t3.`name` AS section, t2.`name` AS class, t1.`section_id` FROM subject t1 LEFT JOIN class t2 ON t1.`class_id` = t2.`class_id` LEFT JOIN section t3 ON t1.`section_id` = t3.`section_id` GROUP BY t3.`section_id` ORDER BY nivel_id ASC")->result_array();
             ...
             <div class="row">
                <div class="col-sm-4">
                   <div class="form-group">
                      ...
                      <input type='text' required="" class="datepicker-here" data-position="top left" data-language='en' name="date_end" data-multiple-dates-separator="/" value="<?php echo $activity_details['date_end'];?>"/>
                   </div>
                </div>
                <div class="col-sm-4">
