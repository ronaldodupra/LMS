                                             ...
                                             <div class="os-tabs-w">
                                                <div class="os-tabs-controls">
                                                   <ul class="navs navs-tabs upper" style="padding-left:20px; padding-top:20px">
                                                      <li class="navs-item mr-3" style="display:inline;">
                                                      ...
                                                      <li class="navs-item mr-3">
                                                         <a class="navs-link" style="color:#000;" data-toggle="tab" href="#tab<?php echo $rows['section_id'];?>"><?php echo $rows['name'];?></a>
                                                      </li>
                                                      <?php endforeach;?>
                                                      <?php endif;?>
                                                   </ul>
                                             ...
                                             <div class="tab-pane active" id="all">
                                                <div class="row" id="results">
                                                   ...
                                                   $students = $this->db->query("SELECT t1.* FROM enroll t1 
                                                     ...
                                                     where t1.class_id = '$class_id' and t1.year = '$running_year'
                                                      ...
                                                      <div class="card-box widget-user ui-block list">
                                                         ...
                                                         <div class="more" style="float:right;">
                                                            ...
                                                            <ul class="more-dropdown">
                                                               ...
                                                               <li><a onclick="delete_student('<?php echo $row['student_id'];?>')" href="#"><?php echo get_phrase('delete');?></a></li>
                                                            </ul>
                                                            <div class="form-group">
                                                               <input type="checkbox" onclick="count_check_subs();" name="id[]" class="form-control select_subs" value="<?php echo $row['student_id'];?>" />
                                                            </div>
                                                         </div>
                                                         
                                                         <div>

                                                            <img src="<?php echo $this->crud_model->get_image_url('student', $row['student_id']);?>" class="img-responsive rounded-circle" alt="user">
