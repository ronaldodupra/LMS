...
<script type="text/javascript">
  ...
  var activity_data = $('#activity_data').val();
    ...
    $.ajax({
        ...
        url:'<?php echo base_url();?>admin/homework/create/',
        method:'POST',
        ...
        {
          window.location.href = '<?php echo base_url();?>admin/homework/' + activity_data;
        }
   ...
   $(document).ready(function() 
    {
      $.ajax({
              url: '<?php echo base_url();?>admin/load_homework_form_froala/'
