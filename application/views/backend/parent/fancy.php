...
<header class="header" id="site-header">
    ...
    <?php if($page_name == 'subject_dashboard' || $page_name == 'upload_marks' || $page_name == 'online_exams' || $page_name == 'online_quiz' || $page_name == 'homework' || $page_name == 'forum' || $page_name == 'study_material' || $page_name == 'subject_marks' || $page_name == 'archived_items'):?>
    ...
    <div class="page-title">
          ...
          <div class="fancy-selector-options active">
            ...
            ?>
            <a href="<?php echo base_url();?>parents/subject_dashboard/<?php echo base64_encode($fc_ex[0].'-'.$fc_ex[1].'-'.$fancy_row2['subject_id']);?>/"><div class="fancy-selector-option">
              <div class="fs-img">
    ...
    <div class="page-title">
          ...
          <div class="fancy-selector-options">
            <?php 
                ...
                foreach($fancy_subjects as $fancy_row2):
            ?>
            <a href="<?php echo base_url();?>parents/cursos/<?php echo base64_encode($fancy_row2['class_id']);?>/"><div class="fancy-selector-option <?php if($fc_info == $fancy_row2['class_id']) echo "active";?>">
              <div class="fs-main-info">
                <div class="fs-name">
    ...
    <div class="header-content-wrapper" style="float: right;" <?php if($page_name != 'cursos'):?> style="padding-left: 85px;"<?php endif;?>>
            ...
            <div class="author-page author vcard inline-items more">
                    ...
                    <div class="more-dropdown more-with-triangle">
                        <div class="mCustomScrollbar" data-mcs-theme="dark">
                            <ul class="account-settings">
                                ...
                                <li>
                                    <a href="<?php echo base_url();?>login/logout/parent">
                ...
                <a href="#" class="author-name fn">
                    <div class="author-title">
                        <?php echo $this->crud_model->get_name('parent', $this->session->userdata('login_user_id'));?> <svg class="olymp-dropdown-arrow-icon"><use xlink:href="<?php echo base_url();?>style/olapp/svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#notification" role="tab">
                    <div class="control-icon has-items">
                        ...
                        <div class="label-avatar bg-success">
                            <?php echo $fancy_count->num_rows();?>
                        </div>
                        <?php endif;?>
                    </div>
                </a>
