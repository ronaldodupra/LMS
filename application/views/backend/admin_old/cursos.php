                                          ...
                                          <div class="tab-pane <?php if($active2 == 1) echo "active";?>" id="tab<?php echo $row['section_id'];?>">
                                             <div class="row">
                                                ...
                                                <?php 
                                                   ...
                                                   $subjects = $this->db->get_where('subject', array('section_id' => $sec_id))->result_array();
                                                         ...
                                                         <div class="friend-item-content">
                                                            <div class="more">
                                                               ...
                                                               <ul class="more-dropdown">
                                                                  ...
                                                                  <li>
                                                                    <a href="<?php echo base_url();?>admin/subject_dashboard/<?php echo base64_encode($row2['class_id']."-".$row['section_id']."-".$row2['subject_id']);?>/"><?php echo get_phrase('dashboard');?>  </a>
                                                                  </li>
                                                                  ...
                                                                  <li>
                                                                    <a onclick="delete_subject('<?php echo $row2['subject_id'];?>','<?php echo $cl_id; ?>')" href="#"><?php echo get_phrase('delete');?>
                                                                    </a>
                                                                  </li>
                                                               </ul>
                                                            </div>
     ...
     function(isConfirm){
       ...
       {        
         ...
         $.ajax({
            ...
            url:"<?php echo base_url();?>admin/check_subject/",
            type:'POST',
            data:{id:id},
            success:function(result)
            {
              ...
              if(result == 0){
                ...
                swal('info','Subject cannot be delete','info');
                 ...
                 window.location.href = '<?php echo base_url();?>admin/courses/delete/' + id + '/' + code;
