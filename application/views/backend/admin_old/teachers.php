                                              ...
                                              <div class="card-box widget-user ui-block list">
                                                  <div class="more" style="float:right;">
                                                          ...
                                                          <ul class="more-dropdown">
                                                              ...
                                                              <li><a onclick="delete_teacher('<?php echo $row['teacher_id'];?>')" href="#"><?php echo get_phrase('delete');?></a></li>
                                                          </ul>
                                                      </div>
                                                  <div>
                                                      <img src="<?php echo $this->crud_model->get_image_url('teacher', $row['teacher_id']);?>" class="img-responsive rounded-circle" alt="user">
                                                      <div class="wid-u-info">
                                                          <a href="<?php echo base_url();?>admin/teacher_profile/<?php echo $row['teacher_id'];?>/" class="h6 author-name"><h5 class="mt-0 m-b-5"> <?php echo $this->crud_model->get_name('teacher', $row['teacher_id']);?></h5></a>
     ...
     function(isConfirm){
       ...
       {        
          ...
          $.ajax({
            ...
            url:"<?php echo base_url();?>admin/check_teacher/",
            type:'POST',
            data:{id:id},
            success:function(result)
            {
              ...
              if(result == 0){
                //alert('cannot be delete');
                 ...
                 window.location.href = '<?php echo base_url();?>admin/teachers/delete/' + id;
              }
