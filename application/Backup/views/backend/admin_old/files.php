  									...
  									<div class="app-email-i">
    									<div class="ae-side-menu">
      										...
      										<ul class="ae-main-menu">
      										    ...
      										    <li class="active"><a href="<?php echo base_url();?>admin/files/"><i class="picons-thin-icon-thin-0177_puzzle_module_connect"></i><span><?php echo get_phrase('home');?></span></a></li>
