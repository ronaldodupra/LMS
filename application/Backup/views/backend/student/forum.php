      ...
      <div class="os-tabs-w menu-shad">
         <div class="os-tabs-controls">
            <ul class="navs navs-tabs upper">
               ...
               <li class="navs-item">
                  <a class="navs-links active" href="<?php echo base_url();?>student/forum/<?php echo $data;?>/"><i class="os-icon picons-thin-icon-thin-0281_chat_message_discussion_bubble_reply_conversation"></i><span><?php echo get_phrase('forum');?></span></a>
               </li>
               <li class="navs-item">
                  ...
                  <div id="newsfeed-items-grid">
                     <div class="element-wrapper">
                        <div class="element-box-tp">
                           <h5 class="element-header"><?php echo get_phrase('forum');?></h5>
                           <div class="os-tabs-w">
                              <div class="os-tabs-controls">
                                 <ul class="navs navs-tabs upper">
                                    <?php 
                                    ...
                                    <table class="table table-padded">
                                       ...
                                       <tbody>
                                          <?php
                                             ...
                                             $forum = $this->db->query("SELECT * from forum where class_id = '$class_id' and section_id = '$section_id' and subject_id = '$ex[2]' and post_status = 1 and semester_id = '$semester_id' order by post_id desc");
                                          ...
                                          <tr>
                                             ...
                                             <td><a class="btn nc btn-rounded btn-sm btn-success" style="color:white"><?php echo date('Y-m-d h:i A', strtotime($row['publish_date'])); ?></a></td>
