                                  ...
                                  <div class="card-box widget-user ui-block list">
                                      <div class="more" style="float:right;">
                                              ...
                                              <ul class="more-dropdown">
                                                  ...
                                                  <li><a onclick="delete_parent('<?php echo $row['parent_id'];?>')" href="#"><?php echo get_phrase('delete');?></a></li>
                                              </ul>
                                          </div>
                                      <div>
     ...
     function(isConfirm){
       ...
       {        
         ...
         $.ajax({
            ...
            url:"<?php echo base_url();?>admin/check_parent/",
            type:'POST',
            data:{id:id},
            success:function(result)
            {
              ...
              if(result == 0){
                //alert('cannot be delete');
                 ...
                 window.location.href = '<?php echo base_url();?>admin/parents/delete/' + id;
              }
