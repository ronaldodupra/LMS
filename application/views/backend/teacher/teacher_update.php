                        ...
                        <div class="ui-block">
                           ...
                           <div class="ui-block-content">
                              ...
                              <div class="row">
                                 ...
                                 <!-- <div class="col-sm-6">
                                    <div class="form-group">
                                       <label class="control-label"><?php //echo get_phrase('zoom_id');?></label>
                                       <input class="form-control"  type="text" name="zoom_id" value="<?php echo $row['zoom_id'];?>" required="">
                                       <span class="material-input"></span>
                                       <span class="material-input"></span>
                                    </div>
                                 </div>
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                       <label class="control-label"><?php //echo get_phrase('update_zoom_password');?></label>
                                       <input class="form-control"  type="password" name="zoom_password">
                                       <span class="material-input"></span>
                                       <span class="material-input"></span>
                                    </div>
                                 </div> -->
                                 <div class="col-sm-12">
                                     <div class="form-group">
                                       <label class="control-label"><?php echo get_phrase('teaching_status');?></label>
                                       <?php $sts = $row['teaching_status']; ?>
                                       <div class="select">
                                          <select value="<?php echo $row['teaching_status']; ?>" name="t_status" required="">
                                             <option value=""><?php echo get_phrase('select');?></option>
                                             <option value="1" <?php if($sts == 1){ echo 'selected';} ?> >
                                                <?php echo get_phrase('advisory_&_subject_teacher');?>
                                             </option>
                                             <option value="2" <?php if($sts == 2){ echo 'selected';} ?>>
                                                <?php echo get_phrase('advisory_only');?> 
                                             </option>
                                             <option value="3" <?php if($sts == 3){ echo 'selected';} ?>>
                                                <?php echo get_phrase('subject_teacher_only');?> 
                                             </option>
                                          </select>
                                       </div>
                                    </div>
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group">
                                       <label class="control-label"><?php echo get_phrase('zoom_link');?></label>
                                       <input class="form-control"  type="text" name="zoom_link" value="<?php echo $row['zoom_link'];?>">
                                       <span class="material-input"></span>
                                       <span class="material-input"></span>
                                    </div>
                                 </div>
