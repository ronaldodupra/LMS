                        ...
                        <div class="element-box-tp">
                           <h5 class="element-header">
                              ...
                              <div style="margin-top:auto;float:right;" class="mr-5">
                                 <a href="#" data-target="#new_post" data-toggle="modal" class="text-white btn btn-control btn-grey-lighter btn-success">
                                       ...
                                       <tbody id="results">
                                          ...
                                          <tr>
                                             ...
                                             <td class="bolder">
                                                ...
                                                <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('view_forum');?>" href="<?php echo base_url();?>admin/forumroom/<?php echo $row['post_code'];?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i></a>
     ...
     function(isConfirm){
       ...
       {        
         ...
         $.ajax({
            ...
            url:"<?php echo base_url();?>admin/check_forum/",
            type:'POST',
            data:{id:id},
            success:function(result)
            {
              ...
              if(result == 0){
                //alert('cannot be delete');
                 ...
                 window.location.href = '<?php echo base_url(); ?>admin/forum/delete/' + id + '/' + data;
