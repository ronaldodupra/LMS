...
<?php
  $quiz_ends_timestamp = strtotime(date('d-M-Y', $this->db->get_where('tbl_online_quiz', array('online_quiz_id' => $online_quiz_id))->row()->quiz_date)." ".$this->db->get_where('tbl_online_quiz', array('online_quiz_id' => $online_quiz_id))->row()->time_end);
  ...
  $questions = $this->db->get_where('tbl_question_bank_quiz', array('online_quiz_id' => $online_quiz_id))->result_array();
  $total_marks = 0;
...
<div class="content-w">
  ...
  <div class="ui-block responsive-flex1200">
    <div class="ui-block-title">
      <h4><?php echo $online_quiz_row->title;?></h4>
        <h4><b><?php echo get_phrase('duration');?></b>: <?php echo ($online_quiz_row->duration / 60).' '.get_phrase('minutes');?></h4>
 ...
 <div class="content-i">
      <div class="content-box">
                          ...
                          <div class="pipeline white lined-primary">            
                            <div class="pipeline-header">
                              <h5><b><?php echo $count++;?>.</b>  <?php echo ($question['type'] == 'fill_in_the_blanks') ? str_replace('^', '__________', $question['question_title']) : $question['question_title'];?> 
                                </h5><span><?php echo get_phrase('mark');?>: <?php echo $question['mark'];?></span>
                            </div>
          ...
          <div class="col-sm-12 text-center">
            <button class="btn btn-rounded btn-success text-center" id="subbutton"><?php echo get_phrase('finish_quiz');?></button>
          </div>
        </form>
      </div>  
    </div>  
