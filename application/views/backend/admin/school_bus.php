               ...
               <div class="element-wrapper">
                  <h6 class="element-header">
                     ...
                     <div style="margin-top:auto;float:right;">
                        <a href="#" data-target="#crearadmin" data-toggle="modal" class="btn btn-control btn-grey-lighter btn-purple">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <a style="color:grey;" onclick="delete_schoolbus('<?php echo $buss['transport_id'];?>')" class="danger" href="#"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
   ...
   function delete_schoolbus(id) {
     ...
     function(isConfirm){
       ...
       {        
         ...
         $('#results').html('<tr><td colspan="7" class="text-center"><b>deleting data...</b></td></tr>');
         window.location.href = '<?php echo base_url();?>admin/school_bus/delete/' + id;
