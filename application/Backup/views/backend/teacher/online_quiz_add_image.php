...
<?php //echo form_open(base_url() . 'teacher/manage_online_quiz_question/'.$online_quiz_id.'/add/image' , array('enctype' => 'multipart/form-data'));?>
...
<script type="text/javascript">
  function save_image(){
    ...
    $.ajax({
          ...
          url:'<?php echo base_url();?>teacher/manage_online_quiz_question/'+online_quiz_id+'/add/image',
          method:'POST',
