                                         ...
                                         <div class="table-responsive" style="margin-top: -1.5%;">
                                            <table class="table table-padded">
                                               <thead>
                                                  <tr>
                                                     <th style="width: 25%;">
                                                        <?php echo get_phrase('title') . ' ' . $time_now; ?>
                                                     </th>
                                                     <th style="width: 30%;">
                                               ...
                                               <tbody>
                                                  <?php
                                                     ...
                                                     $list_of_exam = $this->db->query("SELECT * from online_exam where running_year = '$running_year' and class_id = '$ex[0]' and section_id = '$ex[1]' and subject_id = '$ex[2]' and status = 'published' and semester_id = '$semester_id' order by examdate desc");
                                                  ...
                                                  <tr>
                                                     ...
                                                     <td>
                                                        <?php echo '<b>' . get_phrase('date') . ':</b> ' . date('M d, Y', $row['exam_date']) . '<br>' . '<b>' . get_phrase('hour') . ':</b> ' . date('g:i A', strtotime($row['time_start'])) . ' - ' . date('g:i A', strtotime($row['time_end'])); ?>
                                                     </td>
                                                               ...
                                                               if ($time_now > $row['time_end']){
                                                                ...
                                                                if($is_view == 1){
                                                                  ...
                                                                  if ($status == 'pass' or $status == 'fail')
                                                                       {
                                                                           $query = $this->db->get_where('online_exam_result', array('online_exam_id' => $exam_id,
