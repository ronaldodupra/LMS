    ...
    <div class="col-sm-3 text-center">
      ...
      <div class="user-w">
         ...
         <div class="user-name">
          ...
          <a href="<?php echo base_url();?>teacher/exam_results/<?php echo $param2;?>/" class="btn btn-sm btn-primary"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i> BACK</a> 
      </div>
