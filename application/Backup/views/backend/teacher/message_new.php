                ...
                <div class="form-group label-floating is-select">
                    ...
                    <div class="select">
                        <select name="reciever" id="slct" required="">
                            ...
                            <?php
                                $teachers = $this->db->query("SELECT * FROM teacher ORDER BY last_name ASC");
                            ...
                            <?php
                                ...
                                $parents = $this->db->query("SELECT t4.* FROM student t1
                                            RIGHT JOIN enroll t2 ON t1.`student_id` = t2.`student_id`
                                            RIGHT JOIN section t3 ON t2.`section_id` = t3.`section_id`
                                            RIGHT JOIN parent t4 ON t1.`parent_id` = t4.`parent_id`
                                            WHERE t3.`class_id` = '$class_id'
                                            GROUP BY t4.`parent_id` order by t4.last_name asc");
                            ...
                            <?php
                                ...
                                RIGHT JOIN section t3 ON t2.`section_id` = t3.`section_id`
                                WHERE t3.`class_id` = '$class_id'
                                GROUP BY t1.`student_id` order by t1.last_name asc");
