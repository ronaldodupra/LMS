<form enctype="multipart/form-data" id="form" onsubmit="event.preventDefault(); save_fill_in_the_blanks();"> 
  ...
  <div class="form-group">
    <label class="col-sm-12 control-label">Points <small class="text-danger">( * This field is required.)</small></label>
    <div class="col-sm-12">
  ...
  <div class="field_wrapper">
      ...
      <div class="col-sm-12 text-center text-primary mb-2">
         Answer in Chronological 
      </div>
      <div class="col-sm-12">
        <div class="row">
          <div class="col-sm-12"><input type="text" class="form-control" required="" placeholder="Answer in chronological" name="field_name[]" value=""/></div>
        </div>
      </div>
  </div>
...
<script type="text/javascript">
  $(document).ready(function(){
      ...
      var fieldHTML = '<div class="col-sm-12 mt-2"><div class="row"><div class="col-sm-11"><input type="text" class="form-control" name="field_name[]" placeholder="Answer in chronological" value=""/></div><a href="javascript:void(0);" class="remove_button text-danger"><span class="fa fa-times fa-lg"></span></a></div></div>';
...
<script>
  ...
  $.ajax({
        ...
        url:'<?php echo base_url();?>teacher/manage_online_exam_question/'+online_exam_id+'/add/chronological_order',
        method:'POST',
