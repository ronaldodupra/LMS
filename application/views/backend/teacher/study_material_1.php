...
<?php 
  $info = base64_decode($data); $ex = explode('-', $info); 
...
<script>
        ...
        var buttons = ['paragraphFormat', 'bold', 'italic', 'underline', 'strikeThrough', 'align', 'formatOL', 'formatUL', 'insertTable', 'insertImage', 'insertLink', 'undo', 'redo', 'quote', 'fullscreen', 'html', '|', 'BeyondGrammar'];
        var buttonsSm = ['paragraphFormat', 'bold', 'italic', 'underline', 'strikeThrough', 'align', 'formatOL', 'formatUL', '|', 'BeyondGrammar'];
        $(function () {
            $('#contenteditable').froalaEditor({
            ...
            $('#gethtml').on('click', function () {
                var html = $('#contenteditable').froalaEditor('html.get');
                alert(html);
            });
        });
