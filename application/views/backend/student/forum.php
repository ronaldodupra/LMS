                                    ...
                                    <table class="table table-padded">
                                       ...
                                       <tbody>
                                          <?php
                                             ...
                                             $forum = $this->db->query("SELECT * from forum where class_id = '$ex[0]' and section_id = '$ex[1]' and subject_id = '$ex[2]' and post_status = 1 and semester_id = '$semester_id' order by post_id desc");
