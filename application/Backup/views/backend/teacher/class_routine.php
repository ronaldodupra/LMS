      ...
      <div class="os-tabs-w menu-shad">
         <div class="os-tabs-controls">
            <ul class="navs navs-tabs upper">
               <li class="navs-item">
                  <a class="navs-links active" href="<?php echo base_url();?>teacher/class_routine_view/<?php echo base64_encode($id);?>"><i class="os-icon picons-thin-icon-thin-0024_calendar_month_day_planner_events"></i><span><?php echo get_phrase('class_routine');?></span></a>
               </li>
            </ul>
         </div>
      </div>
      <div class="content-box">
         <div class="row">
            <div class="col col-lg-9 col-md-9 col-sm-12 col-12">
               <?php echo form_open(base_url() . 'teacher/class_routine_view/', array('class' => 'form m-b'));?>
               <div class="form-group label-floating is-select">
                  ...
                  <div class="select">
                     <select onchange="submit();" name="class_id" onchange="submit();">
                        ...
                        <?php $cl = $this->db->get_where('class', array('class_id' => $id))->result_array();
                           foreach($cl as $row):?>
            ...
            <div class="col col-lg-3 col-md-3 col-sm-12 col-12">
               <div class="text-">
                  <button class="btn btn-rounded btn-success btn-upper" onclick="add_routine('<?php echo $id;?>', '<?php echo $sid;?>')" type="button">+ <?php echo get_phrase('add_schedule');?></button><!-- data-target="#addroutine" data-toggle="modal" -->
               </div>
            </div>
         </div>
                                    ...
                                    <div class="pi-settings os-dropdown-trigger">
                                       ...
                                       <div class="os-dropdown">
                                          ...
                                          <ul>
                                             ...
                                             <li>
                                                <a onclick="delete_sched('<?php echo $row2['class_routine_id'];?>','<?php echo base64_encode($row2['class_id']);?>')" href="#"><i class="os-icon picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i><span><?php echo get_phrase('delete');?></span></a>
                                             </li>
                                          </ul>
                                       </div>
                                    </div>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <div class="ui-block-content">
               <?php echo form_open(base_url() . 'teacher/class_routine/create');?>
               <div class="row">
                  <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                     <div class="form-group label-floating is-select">
                        <label class="control-label"><?php echo get_phrase('class');?></label>
                        <div class="select">
                           <select name="class_id" id="cl_id" onchange="get_class_sections(this.value); get_class_subjects(this.value);" required="">
                              <option value=""><?php echo get_phrase('select');?></option>
...
<script type="text/javascript">
   ...
   function get_class_subjects(sec_id) {
     $.ajax({
       url: '<?php echo base_url(); ?>teacher/get_class_subject/' + sec_id,
       success: function (response)
       {
...
<script type="text/javascript">
   function delete_sched(id,class_id) {
     ...
     function(isConfirm){
       ...
       {        
         ...
         window.location.href = '<?php echo base_url();?>teacher/class_routine/delete/' + id + '/' + class_id;
   ...
   function add_routine($class_id, $sec_id){
   
    $("#cl_id").val($class_id);
    get_class_sections($class_id); 
    get_class_subjects($sec_id);
    $("#addroutine").modal('show');
   }
