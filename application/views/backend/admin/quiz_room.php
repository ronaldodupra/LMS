      ...
      <div class="os-tabs-w menu-shad">
         <div class="os-tabs-controls">
            <ul class="navs navs-tabs upper">
               <li class="navs-item">
                  <a class="navs-links active" href="<?php echo base_url();?>admin/quizroom/<?php echo $online_quiz_id;?>/"><i class="os-icon picons-thin-icon-thin-0016_bookmarks_reading_book"></i><span><?php echo get_phrase('quiz_details');?></span></a>
               </li>
               <li class="navs-item">
      ...
      <div class="content-i">
         <div class="content-box">
            <div class="back" style="margin-top:-20px;margin-bottom:10px">      
               <a href="<?php echo base_url();?>admin/online_quiz/<?php echo base64_encode($online_quiz_details['class_id']."-".$online_quiz_details['section_id']."-".$online_quiz_details['subject_id']);?>/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>  
            </div>
            <div class="row">
               <div class="col-md-6">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td style="text-align: center;">
                                       <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/update_online_quiz_question/<?php echo $added_question['question_bank_id'];?>')" class="btn btn-success btn-sm"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new" aria-hidden="true"></i></a>
                                       <a onClick="return confirm('<?php echo get_phrase('confirm_delete');?>')" href="<?php echo base_url();?>admin/delete_question_from_online_quiz/<?php echo $added_question['question_bank_id'];?>"  class="btn btn-danger btn-sm"  data-toggle="tooltip" title="<?php echo get_phrase('delete'); ?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" aria-hidden="true"></i></a>
                                    </td>
                                 </tr>
                                 <?php endforeach; ?>
                                 <?php endif; ?>
               ...
               <div class="col-md-6">
                  <div class="pipeline white lined-success">
                     <div class="panel-heading">
                        <h5 class="panel-title" ><?php echo get_phrase('quiz_details');?></h5>
                     </div>
                     <div class="panel-body">
                        <div style="overflow-x:auto;">
                           <table  class="table table-bordered">
                              <tbody>
                                 <tr>
                                    ...
                                    <td><?php echo $online_quiz_details['title']; ?></td>
                                    <td><b><?php echo get_phrase('date');?></b></td>
                                    <td><?php echo date('d M, Y', $online_quiz_details['quiz_date']); ?></td>
                                 </tr>
                                 <tr>
                                    <td><b><?php echo get_phrase('class');?></b></td>
                                    <td><span class="btn btn-purple btn-sm"><?php echo $this->db->get_where('class', array('class_id' => $online_quiz_details['class_id']))->row()->name; ?></span></td>
                                    <td><b><?php echo get_phrase('time');?></b></td>
                                    <td><?php echo date('g:i A', strtotime($online_quiz_details['time_start'])).' - '.date('g:i A', strtotime($online_quiz_details['time_end'])); ?></td>
                                 </tr>
                                 <tr>
                                    <td><b><?php echo get_phrase('section');?></b></td>
                                    <td><span class="btn btn-success btn-sm"><?php echo $this->db->get_where('section', array('section_id' => $online_quiz_details['section_id']))->row()->name; ?></span></td>
                                    <td><b><?php echo get_phrase('percentage_required');?></b></td>
                                    <td><?php echo $online_quiz_details['minimum_percentage'].'%'; ?></td>
                                 </tr>
                                 <tr>
                                    <td><b><?php echo get_phrase('subject');?></b></td>
                                    <td><?php echo $this->db->get_where('subject', array('subject_id' => $online_quiz_details['subject_id']))->row()->name; ?></td>
...
<script type="text/javascript">
   $(document).ready(function() 
   {
       $('#question_type').on('change', function() {
           ...
           $.ajax({
               url: '<?php echo base_url();?>admin/load_question_type_quiz/' + question_type + '/' + online_quiz_id
