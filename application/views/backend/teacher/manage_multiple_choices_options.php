...
<div class="col-sm-12">
   <div class="form-group">
      ...
      <input type="radio" required="" name="correct_answers[]" id="<?php echo $i; ?>" value="<?php echo $i; ?>" class="custom-control-input"> <label for="<?php echo $i; ?>" class="custom-control-label"></label>
    </div>
	</div>
</div>
<?php endfor; ?>
...
<script>
    (function () {
      ...
      toolbarButtons:{
      'moreText': {
        'buttons': ['wirisEditor', 'wirisChemistry','bold','insertTable', 'italic', 'underline', 'strikeThrough', 'subscript', 'superscript', 'fontFamily', 'fontSize', 'textColor', 'backgroundColor', 'inlineClass', 'inlineStyle', 'clearFormatting']
      }
  },
