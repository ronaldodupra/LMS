                     ...
                     <div class="ui-block">
                        ...
                        <div class="ui-block-content">
                           <div class="row">
                              ...
                              <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                 <div class="form-group label-floating is-select">
                                    <label class="control-label"><?php echo get_phrase('learning_status');?></label>
                                    <div class="select">
                                       <select name="learning_status" required="">
                                          <option value=""><?php echo get_phrase('select');?></option>
                                          <option value="1" <?php if($row['learning_status'] == 1) echo "selected";?>><?php echo get_phrase('regular_student');?></option>
                                          <option value="2" <?php if($row['learning_status'] == 2) echo "selected";?>><?php echo get_phrase('irregular_student');?></option>
                                       </select>
                                    </div>
                                 </div>
                              </div>
