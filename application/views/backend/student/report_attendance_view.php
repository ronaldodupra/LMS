                ...
                <div class="element-box lined-primary shadow">              
                    <div class="row">                
                        ...
                        <div class="col-5 text-right">
                             <img alt="" src="<?php echo $this->crud_model->get_image_url($this->session->userdata('login_type'), $this->session->userdata('login_user_id'));?>" width="20px" style="border-radius:20px;margin-right:5px;"> <?php echo $this->crud_model->get_name('student', $this->session->userdata('login_user_id')); ?>
                        </div>                
                    </div>              
                    ...
                    <table class="table table-sm table-lightborder">
                        <thead>                    
                            ...
                            <?php
                                ...
                                $attendance = $this->db->get_where('attendance', array('section_id' => $section_id, 'class_id' => $class_id, 'year' => $running_year, 'timestamp' => $timestamp,'am_pm' => 1, 'student_id' => $this->session->userdata('login_user_id')))->result_array();
                            ...
                            <?php
                                ...
                                $attendance_pm = $this->db->get_where('attendance', array('section_id' => $section_id, 'class_id' => $class_id, 'year' => $running_year, 'timestamp' => $timestamp, 'student_id' => $this->session->userdata('login_user_id')))->result_array();
