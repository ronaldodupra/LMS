                                    ...
                                    <div class="aec-full-message" style="min-height:800px;">
                                       <div class="message-head">
                                          ...
                                          <a href="<?php echo base_url();?>teacher/upload_file/<?php echo $token;?>" class="btn btn-control bg-success" style="color: #fff; float:right;">
                                             <i class="picons-thin-icon-thin-0124_upload_cloud_file_sync_backup" title="Upload File"></i>
                                             <div class="ripple-container"></div>
                                          </a>
                                          <?php endif;?>
                                       </div>
                                       <div class="message -content" id="results">
                                          <?php if($token == ""):?>     
                                          <ul class="widget w-friend-pages-added notification-list friend-requests">
                                             ...
                                             <li class="inline-items">
                                                ...
                                                <div class="notification-event">
                                                   ...
                                                   <a onclick="delete_folder('<?php echo $row['folder_id'];?>')" href="#"><i style="font-size:15px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full"></i></a>
                                          ...
                                          <ul class="widget w-friend-pages-added notification-list friend-requests">
                                             ...
                                             <li class="inline-items">
                                                ...
                                                <div class="notification-event">
                                                   ...
                                                   <a onclick="delete_file('<?php echo $file['file_id'];?>')" href="#"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" style="font-size:15px;"></i></a>
                                                   <?php echo $param2; ?>
                                                </div>
                                             </li>
                                             <?php endforeach;?>
   ...
   function delete_folder(id) {
     ...
     function(isConfirm){
       ...
       {        
         ...
         window.location.href = '<?php echo base_url();?>teacher/folders/delete/' + id;
   ...
   function delete_file(id) {
     ...
     function(isConfirm){
       ...
       {        
         ...
         $('#results').html('<div class="col-md-12 text-center"><img src="<?php echo base_url();?>assets/images/preloader.gif" /><br><b>deleting data..</b></div>');
         window.location.href = '<?php echo base_url();?>teacher/files/delete/' + id;
