      ...
      <div class="os-tabs-w menu-shad">
         <div class="os-tabs-controls">
            <ul class="navs navs-tabs upper">
               ...
               <li class="navs-item">
                  <a class="navs-links active" href="<?php echo base_url();?>teacher/quiz_edit/<?php echo $online_quiz_id;?>/"><i class="os-icon picons-thin-icon-thin-0001_compose_write_pencil_new"></i><span><?php echo get_phrase('edit');?></span></a>
               </li>
            </ul>
         </div>
      </div>
            ...
            <div>
               <div class="pipeline white lined-primary">
                  <?php
                     ...
                     ?>
                  <?php echo form_open(base_url() . 'teacher/online_quiz/edit/', array('enctype' => 'multipart/form-data')); ?>
                  <div class="row">
                     <div class="col-sm-4">
                     ...
                     <div class="col-sm-4">
                        <div class="form-group">
                           ...
                           <input type='date' required="" class="form-control" name="quiz_date" value="<?php echo $online_quiz['quizdate']; ?>"/>
                        </div>
                     </div>
                     <div class="col-sm-2">
                        <div class="form-group">
                     ...
                     <div class="col-sm-4">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <input type="text" required="" class="form-control" name="minimum_percentage" value="<?php echo $online_quiz['minimum_percentage']; ?>">
                           </div>
                        </div>
                     </div>
                     <div class="col-sm-4">
