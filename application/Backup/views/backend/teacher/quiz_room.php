      ...
      <div class="os-tabs-w menu-shad">
         <div class="os-tabs-controls">
            <ul class="navs navs-tabs upper">
               <li class="navs-item">
                  <a class="navs-links active" href="<?php echo base_url();?>teacher/quizroom/<?php echo $online_quiz_id;?>/"><i class="os-icon picons-thin-icon-thin-0016_bookmarks_reading_book"></i><span><?php echo get_phrase('quiz_details');?></span></a>
               </li>
               <li class="navs-item">
      ...
      <div class="content-i">
         <div class="content-box">
            <div class="back" style="margin-top:-20px;margin-bottom:10px">      
               <a href="<?php echo base_url();?>teacher/online_quiz/<?php echo base64_encode($online_quiz_details['class_id']."-".$online_quiz_details['section_id']."-".$online_quiz_details['subject_id']);?>/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>    
            </div>
            <div class="row">
               <div class="col-md-6">
                              ...
                              <tbody id="results">
                                 ...
                                 <tr>
                                    ...
                                    <td style="text-align: center;">
                                       ...
                                       <a onclick="delete_q('<?php echo $added_question['question_bank_id'];?>')" href="#" class="btn btn-danger btn-sm" data-toggle="tooltip" title="<?php echo get_phrase('delete'); ?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" aria-hidden="true"></i>
                                       </a>
                           ...
                           <table  class="table table-bordered">
                              <tbody>
                                 <tr>
                                    ...
                                    <td><?php echo date('M d, Y', $online_quiz_details['quiz_date']); ?></td>
                                 </tr>
                                 <tr>
