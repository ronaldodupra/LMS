<?php 
   ...
   $chk_advisory = $this->db->query("SELECT teaching_status FROM teacher WHERE teacher_id = '$teacher_id'")->row()->teaching_status;
   $teacher_info = $this->db->get_where('section', array('teacher_id' => $teacher_id))->row_array();

   $cl_id = $teacher_info['class_id'];
   $sec_id = $teacher_info['section_id'];
   $department_id = $this->db->query("SELECT b.`department_id` FROM section a LEFT JOIN class b ON a.`class_id` = b.`class_id` WHERE a.`teacher_id` = '$teacher_id'")->row()->department_id;
?>
<div class="content-w">
                              ...
                              <div class="top-header top-header-favorit">
                                 ...
                                 <div class="profile-section" style="background-color: #fff;">
                                    <div class="control-block-button">
                                       ...
                                       <a data-toggle="modal" onclick="add_student();" class="btn btn-control bg-purple" style="background:#0084ff; color: #fff;">
                                       ...
                                       <a href="javascript:void(0);" onclick="export_student();" class="btn btn-control bg-purple" style="background:#99bf2d; color: #fff;">
            ...
            <div class="form-group label-floating is-select">
               ...
               <div class="select">
                  <select name="class_id" required="">
                     ...
                     <?php $classes = $this->db->get_where('class', array('class_id' => $cl_id))->result_array();
                        foreach($classes as $rowcl):
                     ?>
                     <option value="<?php echo $rowcl['class_id'];?>"><?php echo $rowcl['name'];?></option>
                     <?php endforeach;?>
                  </select>
               </div>
            </div>
            <div class="form-group label-floating is-select">
               ...
               <div class="select">
                  <select name="section_id" required="">
                     <option value=""><?php echo get_phrase('select');?></option>
                     <?php $classes = $this->db->get_where('section', array('section_id' => $sec_id))->result_array();
                        foreach($classes as $rowsc):
                     ?>
                     <option value="<?php echo $rowsc['section_id'];?>"><?php echo $rowsc['name'];?></option>
                     <?php endforeach;?>
                  </select>
               </div>
            </div>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="form-group label-floating is-select">
               ...
               <div class="select">
                  <select name="department_id" required="">
                     <option value=""><?php echo get_phrase('select');?></option>
                     <?php $classes = $this->db->get_where('tbl_department', array('Id' => $department_id))->result_array();
                        foreach($classes as $rowd):
                     ?>
            ...
            <div class="form-group label-floating is-select">
               <label class="control-label"><?php echo get_phrase('class');?></label>
               <div class="select">
                  <select name="class_id" id="cl_id2" required="">
                     <option value=""><?php echo get_phrase('select');?></option>
                     <?php $classes = $this->db->get_where('class', array('class_id' => $cl_id))->result_array();
                        foreach($classes as $acl):
                     ?>
                     <option value="<?php echo $acl['class_id'];?>"><?php echo $acl['name'];?></option>
                     <?php endforeach;?>
                  </select>
               </div>
            </div>
            <div class="form-group label-floating is-select">
               ...
               <div class="select">
                  <select name="section_id" required="" id="section_selector_holder2">
                     <option value=""><?php echo get_phrase('select');?></option>
                     <?php $classes = $this->db->get_where('section', array('section_id' => $sec_id))->result_array();
                        foreach($classes as $asec):
                     ?>
                     <option value="<?php echo $asec['class_id'];?>"><?php echo $asec['name'];?></option>
                     <?php endforeach;?>
                  </select>
               </div>
            </div>
