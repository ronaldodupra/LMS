  									...
  									<div class="app-email-i">
    									<div class="ae-side-menu">
      										...
      										<ul class="ae-main-menu">
        										...
        										<li class="active"><a href="<?php echo base_url();?>admin/recent/"><i class="picons-thin-icon-thin-0117_folder_documents_revert_history"></i><span><?php echo get_phrase('recents');?></span></a></li>
            											...
            											<div class="message-head">
              												<div class="user-w with-status status-green">
                												<div class="user-name">
                  													...
                  													<div class="user-role"><?php $this->db->where('fileorder', date('d/m/Y')); $this->db->where('user_type', 'admin'); $this->db->where('user_id', $this->session->userdata('login_user_id')); echo $this->db->count_all_results('file');?> <?php echo get_phrase('files');?>.</div>
                												</div>
              												</div>
            											</div>
