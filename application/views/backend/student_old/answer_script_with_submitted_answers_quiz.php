...
<div style="text-align: center;">
    <h3><?php echo get_phrase('results');?>: <b><?php echo $online_quiz_info->title;?></b></h3><br>
</div>
<div class="back" style="margin-top:-20px;margin-bottom:10px">		
	        <a href="<?php echo base_url();?>student/online_quiz/<?php echo base64_encode($online_quiz_info->class_id.'-'.$online_quiz_info->section_id.'-'.$online_quiz_info->subject_id);?>/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>	
	</div>
    <?php
