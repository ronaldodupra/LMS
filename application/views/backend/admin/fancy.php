...
<header class="header" id="site-header">
    ...
    <?php if($page_name == 'subject_dashboard' || $page_name == 'upload_marks' || $page_name == 'online_exams' || $page_name == 'online_quiz' || $page_name == 'homework' || $page_name == 'forum' || $page_name == 'study_material' || $page_name == 'subject_marks' || $page_name == 'archived_items' || $page_name == 'live_class' || $page_name == 'video_link'):?>
    <div class="page-title">
          ...
          <div class="fancy-selector-options active">
            <?php 
                $fancy_subjects = $this->db->query("SELECT * FROM subject WHERE class_id='$fc_ex[0]' ORDER BY section_id")->result_array();
                //$fancy_subjects = $this->db->get_where('subject', array('class_id' => $fc_ex[0]))->result_array();
                foreach($fancy_subjects as $fancy_row2):
            ?>
            <a href="<?php echo base_url();?>admin/subject_dashboard/<?php echo base64_encode($fancy_row2['class_id'].'-'.$fancy_row2['section_id'].'-'.$fancy_row2['subject_id']);?>/"><div class="fancy-selector-option">
              <div class="fs-img">
                <img alt="" src="<?php echo base_url();?>uploads/subject_icon/<?php echo $fancy_row2['icon'];?>">
              </div>
              <div class="fs-main-info">
                <div class="fs-name">
                  <?php echo $fancy_row2['name'];?> - (<?php echo $this->db->get_where('section', array('section_id' => $fancy_row2['section_id']))->row()->name;?>)
                </div>
              </div>
            </div></a>
            <?php endforeach;?>
            ...
            <div class="control-icon more has-items">
                ...
                <div class="more-dropdown more-with-triangle triangle-top-center">
                  ...
                  <?php 
                      ...
                      $n = $this->db->get_where('notification', array('user_id' => $this->session->userdata('login_user_id'), 'user_type' => $this->session->userdata('login_type'), 'status' => 0))->result_array();
                    ...
                    <div class="more-dropdown more-with-triangle">
                        <div class="mCustomScrollbar" data-mcs-theme="dark">
                            <ul class="account-settings">
                                ...
                                <li>
                                    <a href="<?php echo base_url();?>login/logout/admin">
