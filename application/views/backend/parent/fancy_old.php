...
<header class="header" id="site-header">
    ...
    <div class="page-title">
          ...
          <div class="fancy-selector-options active">
            ...
            ?>
            <a href="<?php echo base_url();?>parents/subject_dashboard/<?php echo base64_encode($fancy_cl_id.'-'.$fancy_section_id.'-'.$fancy_row2['subject_id'].'-'.$fc_ex[3]);?>/"><div class="fancy-selector-option">
              <div class="fs-img">
