   ...
   <div class="conty">
      ...
      <div class="ui-block responsive-flex1200">
         <div class="ui-block-title">
            ...
            <a href="<?php echo base_url();?>teacher/examroom/<?php echo $online_exam_id; ?>" class="btn btn-rounded btn-info text-center"><span class="fa fa-arrow-left"> </span> <?php echo get_phrase('Back');?></a>
         </div>
      </div>
      <hr>
      <div class="content-i">
                  ...
                  <element class="col-sm-12 col-aligncenter page " id="page<?php echo $var;?>">
                     <div class="pipeline white lined-primary">
                        ...
                        <div class="pipeline-header">
                           ...
                           <?php if ($question['type'] == 'enumeration' || $question['type'] == 'fill_in_the_blanks' || $question['type'] == 'matching_type'){ ?>
                        ...
                        <!-- Multiple Choices -->
                        <?php if ($question['type'] == 'matching_type'): ?>
                        <?php
                        
                           if ($question['matching_type'] != '' || $question['matching_type'] != null)
                            $options = json_decode($question['matching_type']);
                            else
                            $options = array();

                            if ($question['matching_type_answer'] != '' || $question['matching_type_answer'] != null)
                            $options2 = json_decode($question['matching_type_answer']);
                            else
                            $options2 = array(); ?>
                           ...
                           <div class="row">
                              ...
                              <div class="col-sm-6">
                                 <label class="text-primary">Correct Answer</label>
                              </div>
                           <?php for ($i = 0; $i < $question['number_of_options']; $i++){ ?>
                                 ...
                                 <!-- <div class="form-group">
                                     <div class="select">
                                        ...
                                        <select name="semester_id" id="semester_id" required="">
                                           ...
                                           <?php
                                              for($e = 0; $e < $question['number_of_options']; $e++){
                                              ?>
                                           <option value="<?php echo $options2[$e] ?>"><?php echo $options2[$e];?></option>
                                           <?php }?>
                                        </select>
                                     </div>
                                </div> -->
