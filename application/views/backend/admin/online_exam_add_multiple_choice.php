<?php //echo form_open(base_url() . 'teacher/manage_online_exam_question/'.$online_exam_id.'/add/multiple_choice' , array('enctype' => 'multipart/form-data'));?>
 ...
 <form enctype="multipart/form-data" id="form" onsubmit="event.preventDefault();"> 
  ...
  <div class="form-group">
     <div class="col-sm-12">
        <button type="submit" class="btn btn-success btn-block" onclick="save_multiple_choices();"><?php echo get_phrase('save');?></button>
     </div>
  </div>
...
<script type="text/javascript">
  ...
  function save_multiple_choices(){
    ...
    $.ajax({
          ...
          url:'<?php echo base_url();?>admin/manage_online_exam_question/'+online_exam_id+'/add/multiple_choice',
          method:'POST',
