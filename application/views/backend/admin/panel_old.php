                        ...
                        <div class="ui-block paddingtel" >
                           <div class="pipeline white lined-success" >
                              <div class="element-wrapper" >
                                 ...
                                 <div class="form-group">
                                      <input class="form-control" style="height: 35px;" id="filter_exam" placeholder="<?php echo get_phrase('search_exam');?>..." type="text" name="search_key">
                                    </div> 
                                          ...
                                          <div class="users-list-w ">
                                             ...
                                             if($online_exam_today->num_rows() > 0){
                                                ...
                                                foreach($quizzes as $rowe): ?>
                                                   ...
                                                   $attended = $this->db->query("SELECT * from online_exam_result where online_exam_id = '$exam_id' and status = 'attended'")->num_rows();
                                                   ...
                                                   <div class="user-name search_e">
                                                      <a href="<?php echo base_url().'admin/exam_results/'.$rowe['online_exam_id']; ?>" target="_blank">
                                                         <h6 class="user-title min"><?php echo $rowe['title'];?> <br>
                                                           ...
                                                           <span class="badge badge-warning" title="Total Examiners"> <span class="fa fa-users"></span> <?php echo $total_examiner;?></span>
                                                            <span class="badge badge-primary" title="Exam Attendees"> <span class="fa fa-user"></span> <?php echo $attended;?></span>
                                                         </h6>
...
<script type="text/javascript">
   ...
   $("#filter_exam").keyup(function() {
     ...
     $('#results .search_e').each(function() {
