...
<script type="text/javascript">
  ...
  function save_udpate_study_material($param, $exam_id){
      //alert($param +' '+ $exam_id);
     
      $.ajax({
         url:'<?php echo base_url();?>teacher/study_material/update/<?php echo $param2 ?>',
         method:'POST',
         data:$("form#form").serialize(),
         cache:false,
         success:function(data)
         {
         window.location.href = '<?php echo base_url();?>teacher/study_material/<?php echo $param3 ?>';
         }
      });
   }
