         ...
         <div class="row">
            ...
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
               <div class="form-group label-floating is-select">
                  ...
                  <div class="select">
                     <select name="class_id" required="" onchange="subject_holder(this.value);">
            ...
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group label-floating is-select">
                  ...
                  <div class="select">
                    <select name="section_id" required="" id="sub_holder">
                        <option value=""><?php echo get_phrase('select');?></option>
               ...
               <div class="form-group label-floating is-select">
                  ...
                  <div class="select">
                     <select name="teacher_id" required="">
                        <option value=""><?php echo get_phrase('select');?></option>
                        <?php $teachers = $this->db->query("SELECT * from teacher order by last_name asc")->result_array();
...
<script type="text/javascript">
   ...
   function subject_holder(section_id) 
         {
         $.ajax({
              url: '<?php echo base_url();?>admin/get_sectionss/' + section_id ,
