...
$query_teachers = $this->db->query("SELECT t1.*,t2.`id_usuario` FROM section t1
                ...
                GROUP BY t2.`id_usuario` AND t2.`gp`")->num_rows();
...
$user_counter = $query_parents + $query_teachers + $query_student;
?>
   ...
   <div class="conty">
      <div class="row">
            ...
            <div id="panel">
               ...
               <div class="ui-block paddingtel">
                  ...
                  <article class="hentry post has-post-thumbnail thumb-full-width">
                     ...
                     <?php 
                     $file = base_url('uploads/news_images/'.$news_code.'.'.$file_ext);?>
         ...
         <?php  
            ...
            $usuarios = $this->crud_model->get_online_users('student');
         ...
         <?php 
            ...
            $var1 = 0;
            $login_id = $this->session->userdata('login_user_id');
            $grade_id = $this->db->query("SELECT class_id FROM enroll where student_id = '$login_id'")->row()->class_id;
            $birthdays = $this->crud_model->get_birthdays($grade_id,'student');
         ...
         <a href="<?php echo base_url();?>student/birthdays/" class="btn btn-warning btn-sm"><?php echo get_phrase('view_all_birthdays');?></a>
         </div>
         </div>
         </div>
         <?php endforeach;?>
