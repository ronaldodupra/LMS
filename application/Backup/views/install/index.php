      ...
      <legend><span>Verify Purchase</span></legend>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for=""> Username*</label><input class="form-control" placeholder="Codecanyon Username" value="amazcode.ooo" required="" name="code_username" type="text">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="">Purchase Code*</label><input class="form-control" placeholder="amazcode" value="amazcode" name="purchase_code" required="" required type="text"> <small><center><a href="https://amazcode.ooo" target="_blank">Support</a></center></small>
                </div>
              </div>
            </div>
