...
$quiz_details = $this->db->get_where('tbl_online_quiz', array('online_quiz_id' => $param2))->row_array();

?>

<div class="modal-body">
   <div class="modal-header" style="background-color:#00579c">
      <h6 class="title" style="color:white"><?php echo get_phrase('copy_quiz_to:');?></h6>
   </div>
      ...
      <div class="row">
         <div class="col-md-12">
                ...
                <div class="form-group">
                     ...
                     <div class="select">
                        <select id="sec_id" required="" name="sec_id" onchange="subject_holder(this.value);">
                           ...
                           <?php 
                           $class = $this->db->get_where('section', array('class_id' => $quiz_details['class_id']))->result_array();
               ...
               <div class="col-md-8">
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        <input type="text" class="form-control" id="quiz_title" name="quiz_title" value="<?php echo $quiz_details['title']; ?>">
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        <input type='date' id="quiz_date" name="quiz_date" value="<?php echo date('yy-m-d', $quiz_details['quiz_date']); ?>"/>
                     </div>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-3">
                  <div class="form-group">
                     ...
                     <input type="time" required="" id="time_start" name="time_start" class="form-control" value="<?php echo $quiz_details['time_start']; ?>">
                  </div>
               </div>
               <div class="col-md-3">
                  <div class="form-group">
                     <label class="col-form-label" for=""><?php echo get_phrase('end_time');?></label>
                     <input type="time" required="" id="time_end" name="time_end" class="form-control" value="<?php echo $quiz_details['time_end']; ?>">
                  </div>
               </div>
               <div class="col-md-3">
                  <div class="form-group">
                     ...
                     <div class="input-group">
                        <input type="number" min="0" max="100" id="minimum_percentage" required="" class="form-control" placeholder="0 to 100" name="minimum_percentage" value="<?php echo $quiz_details['minimum_percentage']; ?>">
                     </div>
                  </div>
               </div>
               <div class="col-md-3">
                        ...
                        <select name="semester_id" id="sem_id">
                           <option value=""><?php echo get_phrase('select');?></option>
                                 <?php $cl = $this->db->get('exam')->result_array();
                                    foreach($cl as $row):
                                    ?>
                                 <option value="<?php echo $row['exam_id'];?>" <?php if($quiz_details['semester_id'] == $row['exam_id']) echo 'selected';?>><?php echo $row['name'];?></option>
                                 <?php endforeach;?>
                        </select>
                     </div>
                  </div>
            ...
            <div class="form-group">
               ...
               <div class="input-group">
                  <textarea class="form-control" name="instruction" rows="3"><?php echo $quiz_details['instruction']; ?></textarea>
               </div>
            </div>
            <input type="hidden" name="online_quiz_id" id="online_quiz_id" value="<?php echo $param2; ?>">
            <div class="form-group">
        ...
        if(sec_id == 0){
          ...
          swal("LMS", "Please enter semester", "info");
            ...
            $.ajax({
              ...
              url:'<?php echo base_url();?>admin/copy_quiz',
              method:'POST',
              ...
              success:function(data)
              {
                ...
                if(data == 1){
                  ...
                  swal("LMS", "Quiz successfully copied.", "success");
