...
<div style="text-align: center;">
  <div class="alert alert-info">
    <h3><?php echo get_phrase('results');?>: <b><?php echo $online_exam_info->title;?></b></h3>
    <h5><?php
    $query = $this->db->get_where('online_exam_result', array('online_exam_id' => $param2, 'student_id' => $this->session->userdata('login_user_id')));
      if ($query->num_rows() > 0){
