...
<?php
   ...
   $examdate = $this->db->get_where('online_exam', array('online_exam_id' => $online_exam_id))->row()->examdate;

   $time_end = $this->db->get_where('online_exam', array('online_exam_id' => $online_exam_id))->row()->time_end;
   ...
   $questions = $this->db->query("SELECT t1.* FROM question_bank t1
   LEFT JOIN tbl_exam_order t2 ON t1.`type` = t2.`type`
   WHERE t1.`online_exam_id` = '$online_exam_id' GROUP BY t1.`question_bank_id` ORDER BY t2.`order`,t1.`question_bank_id` ASC")->result_array();
   ...
   <div class="conty">
      ...
      <div class="ui-block responsive-flex1200">
         <div class="ui-block-title">
            ...
            <h4><b><?php echo get_phrase('duration');?></b>: <?php echo ($online_exam_row->duration / 60).' '.get_phrase('minutes');?></h4>
            ...
            <h4>
                <button class="btn btn-block btn-rounded btn-info text-center" id="btn_finish" onclick="submit_exam();"><?php echo get_phrase('finish_exam');?></button>
            </h4>
         </div>
      </div>
      <hr>
                     ...
                     <div class="pipeline white lined-primary">
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-4">
                              ...
                              <img class="img-fluid img_style img-round" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_question_image/<?php echo $options[$i];?>');" src="<?php echo base_url();?>uploads/online_exam/<?php echo $options[$i];?>">
...
<script type="text/javascript">
  ...
  function submit_exam(){
        ...
        swal({
          title: "Are you sure ?",
          text: "You want to finish the exam?",
         type: "warning",
