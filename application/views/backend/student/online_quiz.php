                                            ...
                                            <table class="table table-padded">
                                               ...
                                               <tbody>
                                                  <?php
                                                     ...
                                                     $list_of_quiz = $this->db->query("SELECT * from tbl_online_quiz where running_year = '$running_year' and class_id = '$ex[0]' and section_id = '$ex[1]' and subject_id = '$ex[2]' and status = 'published' and semester_id = '$semester_id' order by quizdate desc");
