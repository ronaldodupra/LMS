      ...
      <div class="os-tabs-w menu-shad">
         <div class="os-tabs-controls">
            <ul class="navs navs-tabs upper">
               ...
               <li class="navs-item">
                  <a class="navs-links active" href="<?php echo base_url();?>parents/online_quiz/<?php echo $data;?>/"><i class="os-icon picons-thin-icon-thin-0207_list_checkbox_todo_done"></i><span><?php echo get_phrase('online_quiz');?></span></a>
               </li>
               <li class="navs-item">
                  ...
                  <div id="newsfeed-items-grid">
                     <div class="element-wrapper">
                        <div class="element-box-tp">
                           <h5 class="element-header"><?php echo get_phrase('online_quiz');?></h5>
                           <div class="os-tabs-w">
                              <div class="os-tabs-controls">
                                 <ul class="navs navs-tabs upper">
                                    <?php 
                              ...
                              <div class="tab-pane <?php if($status == 1) echo "active";?>" id="tab<?php echo $row_s['exam_id'];?>">
                                 <div class="table-responsive" style="margin-top: -1.5%;">
                                    <table class="table table-padded">
                                       ...
                                       <tbody>
                                          <?php
                                             $list_of_quiz = $this->db->query("SELECT * from tbl_online_quiz where running_year = '$running_year' and class_id = '$ex[0]' and section_id = '$ex[1]' and subject_id = '$ex[2]' and semester_id = '$semester_id' and status = 'published'");
                                          ...
                                          <tr>
                                             ...
                                             <td class="bolder">
                                                <?php if ($this->crud_model->parent_check_availability_for_student_quiz($row['online_quiz_id'], $ex[3]) != "submitted"): ?>
                                                <span class="btn btn-info btn-rounded"><?php echo get_phrase('waiting_information');?></span>
                                                <?php else: ?>
                                                <?php if($current_time > $quiz_end_time): ?>
                                                <a href="<?php echo base_url();?>parents/online_quiz_result/<?php echo $row['online_quiz_id'];?>/<?php echo $ex[3];?>/" class="btn btn-primary btn-rounded"><?php echo get_phrase('view_results');?></a>
                                                <?php else: ?>
