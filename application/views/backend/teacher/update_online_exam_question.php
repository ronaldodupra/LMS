            ...
            <form enctype="multipart/form-data" id="form" onsubmit="event.preventDefault();">
              ...
              <div class="col-sm-12">
                 <div class="form-group">
                    ...
                    <div class="custom-control custom-radio" style="margin-top:-37px;left:15px; width: 10px;">
                       <input type="radio" name="correct_answers[]" id="<?php echo $i; ?>" value="<?php echo ($i+1); ?>" class="custom-control-input" <?php if(in_array(($i+1), $correct_answers)) echo 'checked'; ?>><label for="<?php echo $i; ?>" class="custom-control-label"></label>
                    </div>
                 </div>
              </div>
              <?php endfor;?>
