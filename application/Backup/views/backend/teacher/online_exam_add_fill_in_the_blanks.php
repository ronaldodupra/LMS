...
<form enctype="multipart/form-data" id="form" onsubmit="event.preventDefault(); save_fill_in_the_blanks();"> 
...
<div class="form-group">
    <label class="col-sm-3 control-label"><?php echo get_phrase('points');?> <small class="text-danger">( * This field is required.)</small></label>
    <div class="col-sm-12">
...
<div class="form-group">
    <label class="col-sm-3 control-label"><?php echo get_phrase('question');?> <small class="text-danger">( * This field is required.)</small></label>
    <div class="col-sm-12">
        <textarea oninput="changeTheBlankColor()" name="question_title" class="form-control" id="question_title" rows="8" cols="80" required=""></textarea>
    </div>
</div>

<!-- image input -->
  <div class="form-group">
     <label class="col-sm-3 control-label"><?php echo get_phrase('Add image');?> <small class="text-primary">(Optional)</small></label>
     <div class="col-sm-12">
...
<div class="form-group">
    <label class="col-sm-6 control-label"><?php echo get_phrase('correct_words');?> <small class="text-danger">( * This field is required.)</small></label>
    <div class="col-sm-12">
...
<script>
    ...
    $.ajax({
          ...
          url:'<?php echo base_url();?>teacher/manage_online_exam_question/'+online_exam_id+'/add/fill_in_the_blanks',
          method:'POST',
